...
<script type="text/javascript">
	...
	function fileType(obj){
        ...
        function abc(a,b){
        	if(b!=180){
    	    	...
    	    	$("#tp").val('');
    	    	//delP('${pd.PATH}','${pd.PICTURES_ID }');
    	    	document.getElementById("tp").files[0] = '请选择图片';
    	    	//$(".ace-file-name").remove();
    	    	return;
    	    }
        }*/
	}
	...
	function delP(PATH,PICTURES_ID){
		 if(confirm("确定要删除图片？")){
			var url = "pictures_ljyl/deltp.do?PATH="+PATH+"&PICTURES_ID="+PICTURES_ID+"&guid="+new Date().getTime();
...
<body>
	<form action="pictures_ljyl/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		...
		<table id="table_report" class="table table-striped table-bordered table-hover">
			...
			<tr>
				<th>链接:</th>
				<td>
					<input type="text" name="LINK" id="LINK" value="${pd.LINK}" style="width:95%;" placeholder="这里输入链接"/>
				</td>
			</tr>
