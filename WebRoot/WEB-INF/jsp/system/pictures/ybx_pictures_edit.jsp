...
<script type="text/javascript">
	...
	function delP(PATH,PICTURES_ID){
		 if(confirm("确定要删除图片？")){
			var url = "pictures_ybx/deltp.do?PATH="+PATH+"&PICTURES_ID="+PICTURES_ID+"&guid="+new Date().getTime();
...
<body>
	<form action="pictures_ybx/${msg }.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
