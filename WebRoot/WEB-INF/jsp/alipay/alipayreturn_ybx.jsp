...
<div class="connectBox">
    ...
    <div style="margin-left: 20%;">
    	<a href="api/ybxkehu/huiyuanzhongxin.do" style="color: #38c4ff;">订单详情</a>
    	<a href="api/ybxkehu/index.do" style="margin-left: 25%;color: #38c4ff;">返回主页</a>
    </div>
...
<script type="text/javascript">
	$(function(){
		...
		var url = "api/ybxkehu/createSession.do";
		   $.ajax({
	             type: "post",
	             url: url,
