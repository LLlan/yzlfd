...
<div class="yinanzaBack">
    <div class="yinanza">
        <p><span>您的位置</span><span> > </span><span>首页</span><span> > </span><span>疑难杂症</span></p>
        <div class="yinansBox">
        	<c:forEach items="${ynzzList }" var="list">
        		<div>
	                <h3>${list.ynzz_name }</h3>
	                ...
	                <a target="_blank" href="<%=basePath %>api/keHuPc/showYnzzDetail.do?ynzz_id=${list.ynzz_id }" style="float:right;margin-right: 46px;text-decoration: none;font-size: 12px;color: #fea01a;">[详情]</a>
	                <%--
	                <p>
	                	${list.ynzz_context }
    ...
    <form action="<%=basePath %>api/keHuPc/showYnzzMore.do" method="post" id="pageForm">
