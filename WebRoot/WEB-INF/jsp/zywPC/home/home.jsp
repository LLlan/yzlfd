...
<html>
  <head>
    ...
    <link rel="stylesheet" href="static/css/zyw/home.css"/>
...
<div class="yisheng">
    <div class="location">
        你的位置&gt;<span>首页</span>&gt;<span>找医生</span>&gt;<span class="xuwei">${xqData.youName }</span>
    </div>
    <div class="ys_conter">
        <div class="ys_lf">
            <div class="ys_img"><img src="<%=basePath %>${xqData.headImg }" alt=""/></div>
            <p>姓　　名：<span class="xuwei">${xqData.youName }</span></p>
            <p>职&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称：<span>${xqData.position }</span></p>
            <p>医&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;院：<span>${xqData.mark }</span></p>
            <p>科&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;类：<span class="xuwei">${xqData.keshiName }</span></p>
            <p>类&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;型：
            	<span class="xuwei">
            		<c:choose>
                   		<c:when test="${xqData.category=='1' }">
                   			中医
                   		</c:when>
                   		<c:when test="${xqData.category=='2' }">
                   			西医
                   		</c:when>
                   		<c:otherwise>
                   			中西医
        ...
        <div class="ys_rt">
            ...
            <p>擅长领域：<span>${xqData.goodField }</span></p>
            <p>就医地址：<span>${xqData.address }</span></p>
            <p><button class="btn4" ng-click="setconversation('${xqData.user_shanghu_id}')">立即咨询</button></p>
        </div>
    </div>
</div>
<!--详情介绍-->
