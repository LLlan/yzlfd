...
<div class="logo">
    <div class="logoBox" style="padding-top: 0px;">
        ...
        <p>注册 <a href="javascript:void(0)">商户端注册</a><a href="<%=basePath %>api/keHuPc/toLogin.do">客户端注册</a><a href="<%=basePath %>api/keHuPc/index.do">返回首页</a></p>
    </div>
</div>
<div class="banBack">
    <div class="banner">
        <div class="loginBox" style="top:50px;">
            ...
            <%--（star） 扫描二维码进行注册的时候用到的参数type:1-通过扫描客户的二维码进行注册;2-通过扫描商户的二维码进行注册。 twoDimensioncode_id:客户或者商户的主键ID--%>
            <input type="hidden" id="type" value="${pd.type }">
            <input type="hidden" id="twoDimensioncode_id" value="${pd.twoDimensioncode_id }">
            <%--（end） --%>
            <%-- 正确的验证码 --%>
            ...
            <p class="rem"><a href="login.html" class="red">登录</a><a href="javascript:void(0)">有账号</a></p>
