...
<div class="logo">
    <div class="logoBox" style="padding-top: 0px;">
        ...
        <p>商户找回密码 <a href="<%=basePath %>api/keHuPc/tosLogin.do">商户端登录</a><a href="<%=basePath %>api/keHuPc/toLogin.do">客户端登录</a><a href="<%=basePath %>api/keHuPc/index.do">返回首页</a></p>
    </div>
</div>
<div class="banBack">
    <div class="banner">
...
$(".danxuan").click(function(){
    ...
    function yanzheng(){
	   ...
	   window.location.href='api/keHuPc/toxinmima1.do?phone='+$("#yzmphone").val()+"&identity="+$("#identity").val();
    }
</script>
</body>
</html>