...
<div class="logo">
    <div class="logoBox" style="padding-top: 0px;">
        ...
        <p>商户设置新密码 <a href="<%=basePath %>api/keHuPc/tosLogin.do">商户端登录</a><a href="<%=basePath %>api/keHuPc/toLogin.do">客户端登录</a><a href="<%=basePath %>api/keHuPc/index.do">返回首页</a></p>
    </div>
</div>
<div class="banBack">
    <div class="banner">
        <div class="loginBox">
            ...
            <p class="rem"><a href="<%=basePath %>api/keHuPc/tosLogin.do" class="red">登录</a><a href="javascript:void(0)">有账号</a></p>
...
<script>
    ...
    function wancheng(){
    	...
    	$.post('api/shangHu/toLoginMissPassword3',{phone:phone,newPassword:password,identity:identity},function(data){
    		if(data.respCode=="00"){
    			layer.alert("该手机号还未注册!点击去注册一个吧",{
    	            ...
    	            ,btn2:function(){
    	            	window.location.href='api/keHuPc/toRegister1.do';
    	            }
    			});
    		}else{
    			layer.msg("修改成功",{
    			...
    			setTimeout("window.location.href='api/keHuPc/tosLogin.do'", 3000);
    		}
    	});
    }
</script>
