...
<div class="yisheng">
    <div class="location">
        你的位置&gt;<span>首页</span>&gt;<span>找药商</span>&gt;<span class="xuwei">${xqData.youName }</span>
    </div>
    <div class="ys_conter">
        <div class="ys_lf">
            <div class="ys_img"><img src="static/images/zyw/yisheng1.png" alt=""/></div>
            <p>药&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;商：<span class="xuwei">${xqData.youName }</span></p>
            ...
            <p class="xixun"><button class="btn7" ng-click="setconversation('${xqData.user_shanghu_id}')">立即咨询</button></p>
            <!--弹出框-->
            <%--<div class="mask" style="display: none;"></div>
            <div class="Consultation" style="display: none;">
                <div class="Consultation_top">
                    专家咨询需要支付咨询费用<span>5</span>元！
                </div>
                <ul>
                    <li><a class="think" href="javascript:void(0);">再想想</a></li>
                    <li><a class="zhifu" href="javascript:void(0);">立即支付</a></li>
                </ul>
            </div>--%>
        </div>
    </div>
