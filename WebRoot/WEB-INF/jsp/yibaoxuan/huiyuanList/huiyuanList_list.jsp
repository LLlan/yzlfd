...
<div class="row-fluid">
	<!-- 检索  -->
	<form action="<%=basePath%>api/ybxshangHu/gethuiyuanlistPage.do" method="post" id="myForm">
	<table>
		<tr>
			<td>
...
<script type="text/javascript">
	...
	function changstate(obj,id){
		...
		bootbox.confirm(msg, function(result) {
			if(result) {
				top.jzts();
				$.post('<%=basePath%>api/ybxshangHu/huiyuanStatus.do',{id:id,status:status},function(data){
