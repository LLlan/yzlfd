...
<div class="main" style="margin-top: 60px;">
    ...
    <form action="api/ybxshangHu/submitXianJinAmountApply.do" method="post" id="submitForm">
...
<script>
    ...
    //点击添加银行卡操作
    function toJump(){
    	window.location.href="api/ybxshangHu/toXianJinAmountApplyAddBlankCard1.do";
    }
  	//点击选择银行卡操作
    function selectBlankCard(){
    	window.location.href="api/ybxshangHu/toXianJinAmountApplySelectBankCard.do";
    }
  	//点击忘记密码操作
    function missPassword(){
    	window.location.href="api/ybxshangHu/toXianJinAmountApplyMissPassword1.do";
    }
</script>
<script>
