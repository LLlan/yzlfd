    ...
    <style>
        body{
         ...
         .persDataBox>a{
		    ...
		    font-size: 16px;
		    background: #fff url(static/yibaoxuan/images/arrow-r_03.png) no-repeat 95%;
		}
    </style>
</head>
<body ontouchstart>
...
<script type="text/javascript">
	...
	function toJump(mark){
		if(mark=="1"){
			window.location.href="api/ybxshangHu/toSettingPersonInformation.do";
		}else if(mark=="2"){
			window.location.href="api/ybxshangHu/toSettingPersonIntroduct.do";
		}else if(mark=="3"){
			window.location.href="api/ybxshangHu/toSettingGoodField.do";
		}else if(mark=='4'){
