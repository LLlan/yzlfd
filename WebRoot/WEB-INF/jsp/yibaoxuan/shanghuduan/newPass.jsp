...
<!--主体开始-->
<div class="main">
    <form class="main_box" action="<%=basePath %>api/ybxshangHu/toLoginMissPassword3.do" method="post" id="myForm">
...
<script type="text/javascript">
	...
	function wancheng(){
		...
		$.post('api/ybxshangHu/toLoginMissPassword3.do',{phone:$("#phone").val(),identity:$("#identity").val(),newPassword:$("#newPassword").val()},function(data){
			if(data.respCode=='01'){
				layer.msg("修改成功",{
		            time:2000,//单位毫秒
				...
				setTimeout("window.location.href='api/ybxshangHu/toLogin.do'", 2000);
			}else{
