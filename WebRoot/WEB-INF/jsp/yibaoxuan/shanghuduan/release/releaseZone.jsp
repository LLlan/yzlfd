...
<div class="searchBox">
    <div class="searchBlock">
        <form action="<%=basePath %>api/ybxshangHu/toRelease.do" method="post">
...
<div class="rongqi">
	<c:forEach items="${list }" var="list">
        ...
        <p class="userName"><img src="static/yibaoxuan/images/ill.png" alt=""/></p>
        <div class="xuqiuB">
...
<script type="text/javascript">
	...
	function lianxihuanzhe(k_id,k_name,s_id,s_name){
		...
		console.log(s_id)
		console.log(s_name)
		location.href="<%=basePath %>api/ybxkehu/lianxihuanzhe.do?ku_id="+k_id+"&kehu_name="+k_name+"&s_id="+s_id+"&s_name="+s_name;    
	}
  ...
  //三大模块之间的跳转
	function toThirdModel(mark){
		if(mark=='1'){
			window.location.href='api/ybxshangHu/toRelease.do';
		}else if(mark=='2'){
