...
<script type="text/javascript">
    function toJump(mark){
    	if(mark=='add'){
    		window.location.href='api/ybxshangHu/toPersonMyServiceAdd.do';
    	}else{
    		window.location.href='api/ybxshangHu/toPersonMyServiceEdit.do?fuwu_id='+mark;
    	}
    }
    function deleteService(fuwu_id){
    	//询问框
    	  layer.open({
    	    	...
    	    	,btn: ['删除', '取消']
    	    	,yes: function(index){
    	    		window.location.href='api/ybxshangHu/deletePersonMyService.do?fuwu_id='+fuwu_id;
    	    	}
    	    	,no:function(index){
    	    		layer.close(index);
    	    	}
