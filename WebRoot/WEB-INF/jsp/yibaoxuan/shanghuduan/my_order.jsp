    ...
    <div id="box"style="clear: both">
        ...
        <c:forEach items="${list }" var="list">
	        <div class="bg-smallbox" style="margin-top:8px;height: 310px;margin-bottom: 10px;">
	           ...
	           <div class="smallbox">
	               <img src="static/yibaoxuan/images/ill.png" style="width: 20%;margin-top: 30px;"/>
	               <div class="ziLiao">
	                   <p>${list.realName }|${list.type=="1"?"字画":list.type=="2"?"古玩":list.type=="3"?"藏品":"玉石" }</p>
...
function lianxihuanzhe(k_id,k_name,s_id,s_name){
	...
	console.log(s_id)
	console.log(s_name)
	location.href="http://lnlcjf.com/api/ybxkehu/lianxihuanzhe.do?ku_id="+k_id+"&kehu_name="+k_name+"&s_id="+s_id+"&s_name="+s_name;    
}
    ...
    li.click(function(){
        ...
        $.post('api/ybxshangHu/personMyOrderYesOrNo.do',{order_state:order_state},function(data){
        	if(data.reqCode=="01"){
        		var str='';
        		$.each(data.list,function(){
        				...
        				str+='<img src="static/yibaoxuan/images/ill.png" style="width: 20%;margin-top: 30px;"/>';
        				str+='<div class="ziLiao">';
        				if(this.type=="1"){
        					str+='<p>'+this.realName+'|字画</p>';
        				}else if(this.type=="2"){
        					str+='<p>'+this.realName+'|古玩</p>';
        				}else if(this.type=="3"){
        					str+='<p>'+this.realName+'|藏品</p>';
        				}else{
        					str+='<p>'+this.realName+'|玉石</p>';
        				}
