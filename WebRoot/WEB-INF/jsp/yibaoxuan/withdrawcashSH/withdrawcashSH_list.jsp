...
<div class="row-fluid">
	<form action="<%=basePath%>api//getSHWithDrawCashlistPage.do" method="post" id="myForm">
...
<div id="submitInformation" style="display: none;margin: 25px 0 0 20px;">
	<form action="api//updateWithDrawCashState.do" method="post" enctype="multipart/form-data" id="updateForm">
