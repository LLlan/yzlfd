...
<script>
	function fenxiangEwm(id){
		//location.href="api/ybxkehu/fenxiangEwm.do?user_kuhu_id="+id;
		var url="<%=basePath %>api/ybxkehu/fenxiangEwm.do?user_kuhu_id="+id+"&type=1";
		url=encodeURIComponent(url);
		location.href="<%=basePath %>api/ybxkehu/fxewm.do?tag=1&fenxiangEwm="+url; 
