...
<div class="wy-header header" style="width:100%;position: fixed;top:0;left:0;z-index: 100;">
    ...
    <div class="wy-header-title">二级团队</div>
</div>
<!--头部结束-->
<!--主体开始-->
<div class="main" style="margin-top: 50px;">
    <p class="first_team">我的二级团队${rpd.num}人</p>
     <c:if test="${ErjiList.size()>0}">
    <c:forEach items="${ErjiList }" var="erji">
	    <div class="team_list">
	        <div class="moumou">
	            <b>${erji.userName }</b>
	            <span>${erji.age }岁</span>
	        </div>
	        <div class="dizhi">
	            <span>地址:</span>
	       			${erji.address }
