...
<div class="main">
    <!--搜索框-->
    <div class="sea-524" style="border-bottom: 1px solid #ddd;">
    ...
    <div class="menu">
        ...
        <section class="tog" style="display: none;">
            <div class="menu_box">
                <div class="left_la">
                    <div class="wrap">
                        <ul id="diqu">
                            <li value="1" class="active"><a href="javascript:;">北京</a></li>
                            ...
                            <li value="25"><a href="javascript:;">云南</a></li>
                            <li value="26"><a href="javascript:;">贵州</a></li>
                            <li value="27"><a href="javascript:;">西藏</a></li>
                            <li value="28"><a href="javascript:;">甘肃</a></li>
                            <li value="29"><a href="javascript:;">宁夏</a></li>
                            <li value="30"><a href="javascript:;">青海</a></li>
                            <li value="31"><a href="javascript:;">新疆</a></li>
                            <li value="32"><a href="javascript:;">香港</a></li>
                            <li value="33"><a href="javascript:;">澳门</a></li>
                            <li value="35"><a href="javascript:;">台湾</a></li>
                        </ul>
                    </div>
                </div>
                <div class="right_la" style="display: none;">
    ...
    <div class="ys_info">
        <div class="ys_detail">
            <div class="img3">
                <a href="regin_info.html"><img src="static/zhaoyiwang/zywkehuduan/images/yisheng_10.png" alt=""/></a>
            </div>
            <ul class="ys">
                <li>
                    <a href="regin_info.html"><b>杨梅</b> | <span>主治医师</span></a>
                </li>
                <li>

                    <a href="regin_info.html">个人</a>
                </li>
                <li>
                    <a href="regin_info.html">中华医学会心电生理和起搏分会青年委员，中国医师协会心血管内科医师分会青年委员，中华医学会江苏省心血管病分会青年委员会副主委，中华全科医学杂志编委;2007年毕业于南京医科大学并任职于南京医科大学第一附属医院(江苏省人民医院)。熟练掌握各种心律失常的诊断与治疗。</a>
                </li>
                <li>
                    <a href="">
