    ...
    <style>
       ...
       /* a{
        ...
        .xuansheng>a>b>i,.type01{
            display:block;width:.75rem;height:.38rem;margin-left:75%;margin-top:-16px;background: url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) no-repeat;background-size:.75rem auto;
        }
...
<div id="header" style="background-color: #38c4ff;">
    ...
    <a href="api/ybxkehu/index.do" class="icon1"><i class="icon-angle-left "></i></a>
</div>
<%--
<div class="searchBox" style="border-bottom: 1px solid #dedede;position: fixed;top:0;z-index: 300;">
    <div class="searchBlock">
        <form action="api/ybxkehu/goDoctor.do" method="post">
...
/*   $(function(){
       $(".xuansheng").on("click",function(){
           if($("#sheng").css("display","block")){
               $(".xuansheng>a>b>i").css({"background":"url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) bottom no-repeat"});
               //$(".ys_info").show();
               //$("#sheng").show();
               $(".mask").show();
               $("#city").show();
             ...
             //  alert("111");
               $(".xuansheng>a>b>i").css({"background":"url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat"});
               //$("#sheng").hide();
               $(".mask").hide();
               $("#city").hide();
           }
    ...
    window.onload=function(){//当页面加载完成执行  html css js
        $(".xuansheng").click(function(){
            $(".tog2").hide();
            $(".tog3").hide();
            $(".type1").find("a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
            $(".type").find("a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
            $(".shi02").css("color","#333");
    ...
    function getName(m1){
		...
		//让原来的内容清空
		$(".ys_info").empty();
		var url = "api/ybxkehu/getDoctorListByAddress.do";
...
<script>
    $(function(){
       /* $(".type").click(function(){
            ...
            $(".type1").find("a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
            $(".shi02").css("color","#333");
            $(".xuansheng").find("a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
            $("#sheng").hide();
            $("#city").hide();
            ...
            if($(".box1").hasClass("have")){
                ...
                $(this).find("a>b .shi02").css("color","#333");
                $(this).find("a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
            }else{
                $(".mask").show();
                $(".sever>section").eq(index-1).show().siblings().hide();
                $(".box1").css("display","block").addClass("have");
                $(this).find("a>b .shi02").css("color","#54ccb4");
                $(this).find("a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) bottom no-repeat");
            }
            //$(".sever>section").eq(index-1).show().siblings().hide()
        ...
        */
        $(".type").click(function(){
         ...
         $(".demo li").click(function(){
                ...
                $(".shi02").css("color","#333");
                $(".type>a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
    ...
    function getkeleiListByParentID(kelei_id){
   	 var url = "api/ybxkehu/getkeleiListByParentID.do";
    	//让原来的内容隐藏
		 $(".right_la ul").empty();
    	 $.ajax({
            type: "post",
    ...
    function chooseKelei(e1){
    		...
    		//把选择好的值赋值到上面
             ...
             $(".shi02").css("color","#333");
             $(".type1>a>b>i").css("background","url(<%=basePath%>static/yibaoxuan/zywkehuduan/images/menu_5.png) top no-repeat");
    }
    ...
    function getDetail(kehu_userId,shanghu_id,userName,yisheng_name,name){
     ...
     //判断session是否存在 做相应的提示
		function checkSession(kehu_userId,shanghu_id,userName,yisheng_name,name){
			...
			if(respCode=="01"){
					window.location.href='<%=basePath%>/api/ybxkehu/getYishengDetail.do?kehu_userId='+kehu_userId+'&yisheng_id='+shanghu_id+'&userName='+userName+'&yishengName='+yisheng_name+'&name='+name+'&type=${pd.type}';
			}else{
				layer.open({
			    	  content:'您还没有登录，马上去？'
			    	  ,btn:['确定','取消']
