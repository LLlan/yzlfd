...
<head>
    ...
    <link rel="stylesheet" href="static/yibaoxuan/css/weui.min.css"/>
...
<div id="header" style="background-color: #38c4ff;">
    ...
    <a href="javascript:void(0)" onclick="window.location.href='api/ybxkehu/huiyuanzhongxin.do'" class="icon1"><i class="icon-angle-left "></i></a>
</div>
<div class="main" style="margin-top: 52px;">
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/ybxkehu/toTixian?money=${pd.money }">
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/ybxkehu/toXianJinAmountApplyRecord.do">
            <div class="weui_cell_bd weui_cell_primary turn_left">
                <p>申请记录</p>
            </div>
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/ybxkehu/fenxiaoMoney.do">
            <div class="weui_cell_bd weui_cell_primary turn_left">
                <p>金额明细</p>
            </div>
            <div class="weui_cell_ft">
...
<script>
    ...
    function toJump(mark){
    	if(mark=='1'){
    		window.location.href="api/ybxshangHu/toXianJinAmountApply.do";
    	}else if(mark=='2'){
    		window.location.href="api/ybxshangHu/toXianJinAmountMyBlankCard.do";
    	}else{
    		window.location.href="api/ybxshangHu/toXianJinAmountApplyRecord.do";
    	}
    }
</script>
</body>
