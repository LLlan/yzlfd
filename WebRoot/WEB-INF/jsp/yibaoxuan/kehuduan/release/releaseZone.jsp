...
<div class="fabu" style="margin-top: 55px;">
    <a href="<%=basePath%>/api/ybxkehu/fabuxuqiu.do">发布需求</a>
</div>
<div class="rongqi" style="margin-bottom: 60px;">

 <c:forEach items="${reslutList}" var="xuqiu" varStatus="index">
    <div class="liebiaoBox">
        <p class="userName"><img src="static/yibaoxuan/zywkehuduan/images/ill.png" alt=""/></p>
        <div class="xuqiuB">
    ...
    <a style="display:inline-block;float:left;border:1px solid red;width:60px;height:25px;line-height:25px;text-align:center;color:#000;font-size: 13px;border-radius:10px;" href="<%=basePath %>api/ybxkehu/tofabuxuqiu.do?xuqiu_id=${xuqiu.xuqiu_id }">编辑</a>
    <a style="display:inline-block;float:right;border:1px solid red;width:60px;heihgt:25px;line-height:25px;text-align:center;color:#000;font-size: 13px;border-radius:10px;" href="<%=basePath %>api/ybxkehu/deleteXuQiu.do?xuqiu_id=${xuqiu.xuqiu_id }">删除</a>
    </div>
  </c:forEach>
