...
<head lang="en">
    ...
    <link href="static/yibaoxuan/zywkehuduan/css/index1.css" type="text/css" rel="stylesheet"/>
    <link href="static/yibaoxuan/zywkehuduan/css/common1.css" type="text/css" rel="stylesheet"/>
    ...
    <style>
        ...
        .sex,.nianlin {
             padding-left: 11px;
             background: url(static/yibaoxuan/zywkehuduan/images/xing_03.png) no-repeat left;
         }
        .releaseBox p label{
...
<div class="bigBox01" >
     ...
     <form  id="xuqiuform" action="<%=basePath%>/api/ybxkehu/${actionMsg }.do" method="post" enctype="multipart/form-data">
     <input type="hidden" value="${pd.xuqiu_id }" name="xuqiu_id">
        ...
        <c:if test="${actionMsg!='updateXuqiu' }">
       		<p class="biaoQ bing">分类<a href="javascript:;" id='show-actions1' class="type">找字画</a></p>
		...
		<div class="weui-cells1" style="display:none;position: fixed;bottom:0;left: 0;background-color: #fff;z-index: 99999;width: 100%;">
		    ...
		    <div id="xiala4"  style="padding: 15px 20px;border-bottom: 1px solid #eee;text-align: center">
		        <div>找玉石</div>
		    </div>
        ...
        <p class="tishi"><img src="static/yibaoxuan/zywkehuduan/images/zys/tishi_03.png" alt=""/>120个字符（包括字母、数字、下划线），不区分大小写</p>
