...
<body>
	<form action="api/shangHu/${msg }.do" method="post" id="Form">
		...
		<table class="table table-striped table-bordered table-hover">
			<tr class="info">
				<td>
					<input type="text" name="jibing_name" id="jibing_name" placeholder="输入常见疾病的名称" value="${pd.jibing_name }"/>
				</td>
				<td>
					<input type="text" name="context" id="context" placeholder="输入疾病的介绍" value="${pd.context }"/>
				</td>
			</tr>
