...
<!--主体开始-->
<div class="main">
    <form class="main_box" action="<%=basePath %>api/shangHu/toLoginMissPassword3.do" method="post" id="myForm">
...
<script type="text/javascript">
	...
	function wancheng(){
		...
		$.post('api/shangHu/toLoginMissPassword3.do',{phone:$("#phone").val(),newPassword:$("#newPassword").val()},function(data){
			if(data.respCode=='01'){
				layer.open({
					content:'密码修改成功'
					,skin:'msg'
				...
				setTimeout("window.location.href='api/shangHu/toLogin.do'", 2000);
			}else{
