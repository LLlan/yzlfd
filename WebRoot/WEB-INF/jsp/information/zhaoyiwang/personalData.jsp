...
<div class="wy-header header" style="width:100%;position: fixed;top:0;left:0;z-index: 100;">
    ...
    <div class="wy-header-title">基本资料</div>
</div>
<!--头部结束-->
<!--主体开始-->
<div class="persDataBox">
    ...
    <a href="javascript:void(0)" onclick="toJump('3');">领域范围</a>
...
<script type="text/javascript">
	...
	function toJump(mark){
		if(mark=="1"){
			window.location.href="api/shangHu/toSettingPersonInformation.do";
		}else if(mark=="2"){
			window.location.href="api/shangHu/toSettingPersonIntroduct.do";
		}else if(mark=="3"){
			window.location.href="api/shangHu/toSettingGoodField.do";
		}else if(mark=='4'){
			window.location.href="api/shangHu/toPayPassword1.do";
		}else{
			/*layer.alert("确认退出该账号吗?退出后将无法进行其他操作!",{
