...
<div id="header" style="background-color: #38c4ff;">
    ...
    <a href="javascript:void(0)" onclick="window.location.href='api/zywkehu/huiyuanzhongxin.do'" class="icon1"><i class="icon-angle-left "></i></a>
</div>
<div class="main" style="margin-top: 52px;">
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/zywkehu/toXianJinAmountApplyRecord.do">
            <div class="weui_cell_bd weui_cell_primary turn_left">
                <p>申请记录</p>
            </div>
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/zywkehu/fenxiaoMoney.do">
            <div class="weui_cell_bd weui_cell_primary turn_left">
                <p>金额明细</p>
            </div>
            <div class="weui_cell_ft">
    ...
    function toJump(){
		...
		if(payPassword==""){
			layer.open({
				...
				,btn:['确定','退出']
				,yes:function(index){
					window.location.href="api/zywkehu/toPayPassword1.do";
				}
				,no:function(index){
					layer.close(index);
				}
		...
		window.location.href="api/zywkehu/toTixian?money=${pd.money }";
    	/*if(mark=='1'){
