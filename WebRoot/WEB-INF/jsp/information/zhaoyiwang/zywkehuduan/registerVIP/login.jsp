...
<!--主体开始-->
   <div class="main">
    ...
    <div class="forget"><a href="api/zywkehu/wangjimima.do" style="text-decoration: underline;">忘记密码？</a></div>
    ...
    <div class="log-reg">
           ...
           <c:choose>
           		<c:when test="${not empty pd.twoDimensioncode_id }">
           			<a href="api/zywkehu/toRegister2.do?twoDimensioncode_id=${pd.twoDimensioncode_id }&type=${pd.type}" style="font-size: 14px;">没有账号？去注册</a>
           		</c:when>
           		<c:otherwise>
           			<a href="api/zywkehu/toRegister.do" style="font-size: 14px;">没有账号？去注册</a>
           		</c:otherwise>
           </c:choose>
		...
		function checkLogin(){
	          $.ajax({
	             ...
	             success: function(data){
	           		if(data.respCode=="01"){
	           			//location.href="api/zywkehu/index.do?tag=1&twoDimensioncode_id="+data.twoDimensioncode_id;
	           			location.href="api/zywkehu/index1.do?tag=1&twoDimensioncode_id="+data.twoDimensioncode_id;
