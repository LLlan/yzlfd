...
<base href="<%=basePath%>">
    ...
    <style>
        ...
        .wy-header-icon-back a {
		    ...
		    height: 20px;
		    margin: 7px 0 0 10px;
		    background: url(static/zhaoyiwang/images/zys/icon-back.png) no-repeat;
...
<div class="persDataBox">
    ...
    <a href="api/zywkehu/gerenziliao.do?user_kuhu_id=${pd.user_kuhu_id}">个人信息</a>
    <a href="api/zywkehu/myEwm.do?user_kuhu_id=${pd.user_kuhu_id}">我的二维码</a>
    <a href="api/zywkehu/myTeam.do?user_kuhu_id=${pd.user_kuhu_id}">我的团队</a>
    <a href="api/zywkehu/myJifen.do?user_kuhu_id=${pd.user_kuhu_id}">我的积分</a>
    <a href="api/zywkehu/myGuquan.do?user_kuhu_id=${pd.user_kuhu_id}">我的股权</a>
    <a href="api/zywkehu/myXunibi.do?user_kuhu_id=${pd.user_kuhu_id}">我的虚拟币</a>
    <a href="api/shangHu/getCunKuanList.do?user_id=${pd.user_kuhu_id}">存款管理</a>
    <a href="api/zywkehu/toPayPassword1.do">提现密码</a>
    <!-- <a href="api/zywkehu/registerSH.do">注册成为商户</a> -->
    <a href="api/zywkehu/shangjiaRegister.do">注册成为商户</a>
</div>
<!--主体结束-->
