...
<div class="wy-header header" style="width:100%;position: fixed;top:0;left:0;">
    ...
    <div class="wy-header-title">资质认证</div>
</div>
<!--头部结束-->
<!--主体开始-->
<div class="apply" style="padding-top:50px;">
    <p style="width: 100%;padding: 10px 0 0 15px;color: #A9A9A9;">温馨提示：请上传商家资质证书拍照图片、您的身份证照片、成功治愈的案例图片
</p>
    <form action="api/shangHu/savePersonApplyStore.do" method="post" enctype="multipart/form-data" id="myForm1">
	        ...
	        <div style="position: relative;top:10px;left:5%;">
	            <div class="img-box full" style="margin:0;width:80px;background-color: #fff;">
	                <section class=" img-section" style="">
	                    <div class="z_photo upimg-div clear" style="border:none;">
	                        <section class="z_file fl"  style="margin:0;width:80px;border:1px solid #ddd;">
	                            <img src="static/zhaoyiwang/images/add1.png" class="add-img1" style="margin:0;width:80px;height:80px;">
...
<!-- <script src="static/zhaoyiwang/zywkehuduan/js/imgUp.js"></script> -->
<%--<script src="static/zhaoyiwang/js/imgUp2.js"></script>--%>
