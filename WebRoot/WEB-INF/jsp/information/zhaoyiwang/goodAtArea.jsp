...
<div class="wy-header header" style="width:100%;position: fixed;top:0;left:0;">
    ...
    <div class="wy-header-title">领域范围</div>
</div>
<!--头部结束-->
<!--主体开始-->
<form action="<%=basePath %>api/shangHu/saveSettingGoodField.do" method="post" id="myForm">
	<input type="hidden" value="${pd.user_shanghu_id }" name="user_shanghu_id">
	<div class="dispBox">
	    <p>领域范围 : </p>
	    <textarea style="height: 250px;" name="goodField" id="goodField" placeholder="请输入你擅长的领域或者经营范围...">${pd.goodField }</textarea>
	</div>
</form>
