...
<div class="main" style="margin-top: 60px;">
    ...
    <form action="api/shangHu/submitXianJinAmountApply.do" method="post" id="submitForm">
    ...
    <div class="pop" style="display: none;">
        ...
        <div class="pop_bottom">
            ...
            <h5><a href="api/shangHu/toPayPassword1.do">忘记密码?</a></h5>
            <div class="input">
...
<script>
	...
	function enterPayPassword(){
		...
		$.post('api/shangHu/submitXianJinAmountApply.do'
				,{
				...
				,function(data){
					if(data.respCode=="00"){//登录失效
						...
						setTimeout("window.location.href='api/shangHu/toPersonXianJinAmount.do'", 1500);
