...
<div class="row-fluid">
	<!-- 检索  -->
	<form action="<%=basePath%>api/order/getOrderOfKeHulistPage.do" method="post" id="myForm">
	<table>
		<tr>
			<td>
	...
	<table id="table_report" class="table table-striped table-bordered table-hover">
		...
		<tr>
			...
			<th class='center'>商户用户名</th>
			<th class='center'>商户手机号</th>
			<th class='center'>商户身份</th>
		...
		<c:choose>
			<c:when test="${not empty list}">
				...
				<tr>
					...
					<td class='center'>${var.shuserName}</td>
					<td class='center'>${var.shPhone}</td>
					<td class='center'>
						<c:choose>
					...
					<td class='center'>
						<c:choose>
							<c:when test="${var.order_state=='1' }"><span style="color:#32CD32">已就诊</span></c:when>
