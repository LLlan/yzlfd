...
<head lang="en">
    ...
    <link href="static/lvjuyanglao/zywkehuduan/css/index1.css" type="text/css" rel="stylesheet"/>
    <link href="static/lvjuyanglao/zywkehuduan/css/common1.css" type="text/css" rel="stylesheet"/>
    ...
    <style>
        ...
        .sex,.nianlin {
             padding-left: 11px;
             background: url(static/lvjuyanglao/zywkehuduan/images/xing_03.png) no-repeat left;
         }
        .releaseBox p label{
...
<div class="bigBox01" >
     ...
     <form  id="xuqiuform" action="<%=basePath%>/api/ljylkehu/${actionMsg }.do" method="post" enctype="multipart/form-data">
     <input type="hidden" value="${pd.xuqiu_id }" name="xuqiu_id">
        ...
        <c:if test="${actionMsg!='updateXuqiu' }">
       		<p class="biaoQ bing">分类<a href="javascript:;" id='show-actions1' class="type">找酒店</a></p>
       		
			<input type="hidden" id="types" name="type" value="找酒店">
       	</c:if>
		...
		<p class="inp bing"><label for="deseaseH" class="bioati";>标题： </label><input type="text" id="deseaseH" name="disease" value="${pd.disease }" placeholder="请输入标题" /></p>
        <p class="bing">内容 :</p>
        <textarea type="text" maxlength="120" name="symptom" id="symptom" placeholder="请输入详细内容" class="areaBox"/>${pd.symptom }</textarea>
        <p class="tishi"><img src="static/lvjuyanglao/zywkehuduan/images/zys/tishi_03.png" alt=""/>120个字符（包括字母、数字、下划线），不区分大小写</p>
        <p class="chuan">上传相关的照片 :</p>
                    ...
                    <div class="z_photo upimg-div clear" style="border:none; ">
                    	<c:forEach items="${imgList }" var="va">
	                        ...
	                        <section class="up-section fl">
	                        	...
	                        	<img onclick="del(this);" class="close-upimg" tid="${va.xuqiu_img_id }" src="static/lvjuyanglao/zywkehuduan/images/zys/a7.png">
	                        	<img class="up-img" src="${va.img_url }">
	                        </section>
                    	</c:forEach>
                   		<c:if test="${imgList.size()!=4 }">
                   			<section class="z_file fl"  style="margin:0;width:80px;">
	                            <img src="static/lvjuyanglao/zywkehuduan/images/zys/add01.png" class="add-img" style="margin:0;width:80px;border:1px solid #eee;">
...
<script src="static/lvjuyanglao/zywkehuduan/js/imgUp-fbxq.js"></script>
