    ...
    $(function(){
     ...
     $(".left>li").click(function(){
            	...
            	success:function(data){
            		...
            		//每次点击清空原来ul下的所有li标签
            			...
            			for(var i=0;i<data.diseaseList.length;i++){
            				var appendhtml='<li onclick="showDetailByID(this)" tid="'+data.diseaseList[i].ynzz_id+'">'+data.diseaseList[i].ynzz_name+'</li>';
        ...
        function showDetailByID(e1){
        	var id = $(e1).attr("tid");
        	location.href='api/zywkehu/showYnzzDetailByID.do?ynzz_id='+id; 
        }
