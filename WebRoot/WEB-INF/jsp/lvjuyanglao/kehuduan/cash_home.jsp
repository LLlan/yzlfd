...
<div id="header" style="background-color: #38c4ff;">
    ...
    <a href="javascript:void(0)" onclick="window.location.href='api/ljylkehu/huiyuanzhongxin.do'" class="icon1"><i class="icon-angle-left "></i></a>
</div>
<div class="main" style="margin-top: 52px;">
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/ljylkehu/toTixian?money=${pd.money }">
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/ljylkehu/toXianJinAmountApplyRecord.do">
            <div class="weui_cell_bd weui_cell_primary turn_left">
                <p>申请记录</p>
            </div>
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="api/ljylkehu/fenxiaoMoney.do">
            <div class="weui_cell_bd weui_cell_primary turn_left">
                <p>金额明细</p>
            </div>
            <div class="weui_cell_ft">
