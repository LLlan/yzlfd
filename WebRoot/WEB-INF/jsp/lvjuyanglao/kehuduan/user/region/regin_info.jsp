...
<div id="header" style="background-color: #38c4ff;">
    ...
    <a href="api/ljylkehu/goDoctor.do?type=${pd.type }" class="icon1"><i class="icon-angle-left "></i></a>
</div>
<div class="main">
    <!--医生简介-->
    <div class="ys_info" >
...
<%-- end --%>
<form action="api/ljylorder/toRegin_pay.do" method="post" id="myForm">
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
 	  function lijizixun(kehu_id,shanghu_id,userName,shanghuName){
	      ...
	      location.href=<%=basePath%>+"api/ljylkehu/myqq.do?kehu_userId="+kehu_id+"&shanghu_userId="+shanghu_id+"&userName="+userName+"&shanghuName="+shanghuName+"&identity=4";    
    		
    }
    
    
    function pingjiajilu(id){
    	location.href="api/ljylkehu/pingjiajilu.do?user_shanghu_id="+id;
    }
	...
	function checkSession(id){
		...
		if(respCode=="01"){
			...
			window.location.href='api/ljylorder/toRegin_pay.do?fuwu_id='+id+"&WIDshow_url="+WIDshow_url;
		}else{
			 	 layer.confirm('您还没有登录，马上去？', {
 			                btn: ['确定']['取消'],
 			                title:'温馨提示',
