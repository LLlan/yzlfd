...
<!--主体开始-->
   <div class="main">
    ...
    <div class="forget"><a href="api/ljylkehu/wangjimima.do" style="text-decoration: underline;">忘记密码？</a></div>
    ...
    <div class="log-reg">
        <span>
           <span>
           </span><a href="api/ljylkehu/toRegister.do" style="font-size: 14px;">没有账号？去注册</a>
...
<script type="text/javascript">
	...
	//检查服务器验证登录
		function checkLogin(){
	          $.ajax({
	             type: "post",
	             url: "api/ljylkehu/login.do",
	             data: {userName:$("#userName").val(),password:$("#password").val(),twoDimensioncode_id:$("#dc_id").val()},
	             dataType: "json",
	             success: function(data){
	           		if(data.respCode=="01"){
	           			//location.href="api/ljylkehu/index.do?tag=1&twoDimensioncode_id="+data.twoDimensioncode_id;
