...
<div class="main">
   ...
   <!--  <div class="log-reg" style="margin-top:35px;">
        <span>
            <a href="api/ljylkehu/toLogin.do" class="bor-right">登录</a><span>|</span><a href="register.html">注册</a>
        </span>
    </div> -->
    </form>
</div>
    ...
    function Register(){
    	//var form = new FormData(document.getElementById("subForm"));
    		if($("#yzm").val()!=$("#fhyzm").val()){
	          ...
	          $.ajax({
	                url:"api/ljylkehu/ew_register.do",
	                type:"post",
	                ...
	                success:function(data){
	                	if(data.respCode=="01"){
	                		 layer.msg("注册成功！",{
	                     		...
	                     		setTimeout( function(){
			    		        	 window.location.href="api/ljylkehu/toLogin.do?twoDimensioncode_id="+data.twoDimensioncode_id;
			    		        },1500);
	                	}else{
