...
<div class="row-fluid">
	<form action="<%=basePath%>api/ljylshangHu/getKHWithDrawCashlistPage.do" method="post" id="myForm">
...
<div id="submitInformation" style="display: none;margin: 25px 0 0 20px;">
	<form action="api/ljylshangHu/updateWithDrawCashState.do" method="post" enctype="multipart/form-data" id="updateForm">
		...
		图片(转账图片)：<input style="76px;" type="file" name="imgPatnFile" id="imgPatnFile" accept="images/jpg,images/jpeg,images/png,images/bmp"><br><br>
