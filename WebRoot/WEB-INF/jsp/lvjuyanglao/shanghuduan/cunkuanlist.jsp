...
<div class="save_money"><a href="api/ljylshangHu/toCunKuan.do?user_id=${pd.user_id }">我要存款</a></div>
<script src="static/lvjuyanglao/layer/mobile/layer.js"></script>
<script>
    function quchu(cunkuan_id,user_id){
    	$.post('api/ljylshangHu/quchudaoyue.do',{cunkuan_id:cunkuan_id},function(data){
    		layer.open({
    		    type: 2
    		    ,content: '正在处理中'
    		    ,shadeClose: false
    		...
    		setTimeout(function(){
    			window.location.href="api/ljylshangHu/getCunKuanList.do?user_id="+user_id;
    		}, 2000);
    	});
    }
