...
<div class="main" style="margin-top: 60px;">
    ...
    <div class="weui_cells weui_cells_access">
        <a class="weui_cell" href="javascript:void(0)" onclick="selectBlankCard();">
            <div class="weui_cell_hd"><img src="static/lvjuyanglao/images/jiansheyinhang.png" style="width: 40px;height: 40px;" alt="" ></div>
    ...
    <div class="weui_cells weui_cells_access" style="margin-top: 5px">
        <a class="weui_cell" href="javascript:void(0)" onclick="toJump();">
            <div class="weui_cell_hd">
                <label  class="weui_label" style="width: 40px;"><img src="static/lvjuyanglao/images/add2.png" style="width: 40px;height: 40px;vertical-align: middle;margin-right: -10px;" alt=""/></label>
            </div>
    ...
    <form action="api/ljylshangHu/submitXianJinAmountApply.do" method="post" id="submitForm">
...
<script>
    ...
    //点击添加银行卡操作
    function toJump(){
    	window.location.href="api/ljylshangHu/toXianJinAmountApplyAddBlankCard1.do";
    }
  	//点击选择银行卡操作
    function selectBlankCard(){
    	window.location.href="api/ljylshangHu/toXianJinAmountApplySelectBankCard.do";
    }
  	//点击忘记密码操作
    function missPassword(){
    	window.location.href="api/ljylshangHu/toXianJinAmountApplyMissPassword1.do";
    }
</script>
<script>
