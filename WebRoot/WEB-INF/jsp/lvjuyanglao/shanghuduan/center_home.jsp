                ...
                <ul>
                    <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('4');">
                            <i><img src="static/lvjuyanglao/images/dingdan.png" alt=" 我的订单"></i>
                           	我的订单
                        </a>
                    </li>
                     <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('8');">
                            <i><img src="static/lvjuyanglao/images/fuwu.png" alt="我的产品"></i>
                            	我的产品
                        </a>
                    </li>
                   <!--  <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('5');">
                            <i><img src="static/lvjuyanglao/images/tuandui.png" alt="我的团队"></i>
                            	我的团队
                        </a>
                    </li> -->
                    <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('6');">
                            <i><img src="static/lvjuyanglao/images/shengqing.png" alt="申请开店"></i>
                          	 资质认证材料
                        </a>
                    </li>
                  <!--   <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('7');">
                            <i><img src="static/lvjuyanglao/images/erweima.png" alt="我的二维码"></i>
                          	  我的二维码
                        </a>
                    </li> -->
                   ...
                   <!--  <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('9');">
                            <i><img src="static/lvjuyanglao/images/shangjia.png" alt="商户余额"></i>
                            	成交金额
                        </a>
                    </li> -->
                ...
                <!--     <li>
               		...
               		<li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('11');">
                            <i><img src="static/lvjuyanglao/images/erweima.png"></i>
                           	存款管理
                        </a>
                    </li>
                <!-- <li>
                        <a href="api/ljylshangHu/toSettingExample.do">
                            <i><img src="static/lvjuyanglao/images/shangjia.png"></i>
                           	 我的案例
                        </a>
                    </li>-->
                   <li>
                        <a href="javascript:void(0)" onclick="toPersonCenterJump('1');">
                            <i><img src="static/lvjuyanglao/images/shezhi.png" alt="设置"></i>
                            	设置
                        </a>
                    </li>
                </ul>
...
<script>
	...
	function toThirdModel(mark){
		if(mark=='1'){//进入需求大厅
			isStateApplyStore('api/ljylshangHu/toRelease.do');
		}else if(mark=='2'){//联系我们
    ...
    function toPersonCenterJump(mark){
    	if(mark=="1"){
    		isStateApplyStore('api/ljylshangHu/toPersonCenterSetting.do');
    	}else if(mark=="2"){
    		isStateApplyStore('api/ljylshangHu/toPersonXianJinAmount.do');
    	}else if(mark=="3"){
    		isStateApplyStore('api/ljylshangHu/toPersonMyJiFen.do');
    	}else if(mark=="4"){
    		isStateApplyStore('api/ljylshangHu/toPersonMyOrder.do');
    	}else if(mark=="5"){
    		...
    		isStateApplyStore('api/ljylshangHu/myTeam.do');
    	}else if(mark=="6"){
    		$.post('api/ljylshangHu/isPerfectPersonInformation.do',{},function(date){
    			if(date.respCode=="00"){
    				/*layer.confirm('您的个人信息还未完善,点击确定去完善信息', {
    		...
    		isStateApplyStore('api/ljylshangHu/toPersonMy2WeiMa.do');
    	}else if(mark=="8"){
    		isStateApplyStore('api/ljylshangHu/toPersonMyService.do');
    	}else if(mark=="9"){
    		isStateApplyStore('api/ljylshangHu/toPersonShangHuMoney.do');
    	}else if(mark=="10"){
    		isStateApplyStore('api/ljylshangHu/toPersonMyGuQuan.do');
    	}else if(mark=="11"){
    		isStateApplyStore('api/ljylshangHu/getCunKuanList.do');
    	}else{
    		isStateApplyStore('api/ljylshangHu/toPersonMyXuNiBi.do');
    	}
    }
    //根据认证状态，进行提示
