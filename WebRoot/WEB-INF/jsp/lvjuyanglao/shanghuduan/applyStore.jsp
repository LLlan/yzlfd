...
<head>
    ...
    <link href="static/lvjuyanglao/css/common1.css" type="text/css" rel="stylesheet"/>
    <link href="static/lvjuyanglao/css/index1.css" type="text/css" rel="stylesheet"/>
    <title>商家认证</title>
    <style>
        .bgSelected{
...
<div class="apply" style="padding-top:50px;">
    ...
    <form action="api/ljylshangHu/savePersonApplyStore.do" method="post" enctype="multipart/form-data" id="myForm1">
	            ...
	            <div class="img-box full" style="margin:0;width:80px;background-color: #fff;">
	                <section class=" img-section" style="">
	                   ...
	                   <!--      <section class="z_file fl"  style="margin:0;width:80px;border:1px solid #ddd;">
	                            <img src="static/lvjuyanglao/images/add1.png" class="add-img" style="margin:0;width:80px;height:80px;">
	        ...
	        <div style="position: relative;top:10px;left:5%;">
	            <div class="img-box full" style="margin:0;width:80px;background-color: #fff;">
	                <section class=" img-section" style="">
	                    <div class="z_photo upimg-div clear" style="border:none;">
	                        <section class="z_file fl"  style="margin:0;width:80px;border:1px solid #ddd;">
	                            <img src="static/lvjuyanglao/images/add1.png" class="add-img1" style="margin:0;width:80px;height:80px;">
...
<!-- <script src="static/lvjuyanglao/zywkehuduan/js/imgUp.js"></script> -->
<%--<script src="static/lvjuyanglao/js/imgUp2.js"></script>--%>
