...
<div class="wy-header header" style="width:100%;position: fixed;top:0;left:0;">
    ...
    <div class="wy-header-title">简介</div>
</div>
<!--头部结束-->
<!--主体开始-->
<form action="<%=basePath %>api/ljylshangHu/saveSettingPersonIntroduct.do" method="post" id="myForm">
	<div class="dispBox">
	    <p>简介 : </p>
	    <textarea style="height: 250px;" name="introduct" id="introduct" placeholder="请输入简介，让别人更了解您...">${pd.introduct }</textarea>
	</div>
</form>
