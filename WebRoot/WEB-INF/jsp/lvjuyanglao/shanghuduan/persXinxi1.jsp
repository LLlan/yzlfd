...
<head>
    ...
    <link rel="stylesheet" href="static/lvjuyanglao/css/demos.css">
    <title>个人信息</title>
    <style>
        body{
...
<!--头部结束-->
<!--主体开始-->
<form action="<%=basePath %>api/ljylshangHu/savePersonInformation.do" method="post" enctype="multipart/form-data" id="myForm">
...
<script src="static/lvjuyanglao/js/imgUp1.js"></script>
<script src="static/lvjuyanglao/lib/fastclick.js"></script>
<script src="static/lvjuyanglao/zywkehuduan/js/city-picker.js"></script>
...
<script src="static/lvjuyanglao/js/city-picker.js"></script>
<script>
    $("#start").cityPicker({
        title: "选择出发地",
        onChange: function (picker, values, displayValues){
