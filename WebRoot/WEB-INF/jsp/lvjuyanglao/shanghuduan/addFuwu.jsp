...
<!--头部结束-->
<!--主体开始-->
<form action="<%=basePath %>api/ljylshangHu/${msg }.do" method="post" id="myForm" enctype="multipart/form-data">
    	...
    	<c:if test="${msg!='updatePersonMyService' }">
	    	<li>
	        	...
	        	<select name="type" style="border: 1px solid #e8d8d8;height: 30px;margin-left: 12px;">
	        		<option value="1" selected="selected">酒店产品</option>
	        		<option value="2">景点产品</option>
	        		<option value="3">特产产品</option>
	        	</select>
	        </li>
        </c:if>
