...
@Controller
@RequestMapping(value="/api/ybxshangHu")
public class YbxShangHuController extends BaseController{
	...
	public ModelAndView toRelease() throws Exception{
		...
		if(isSession()){
			...
			List<PageData> list1=ybxShangHuService.getxuqiuList(pd);
			for(PageData tempPd:list1){
				...
				List<PageData> tempList=ybxShangHuService.getxuqiuimgList(tempPd);
			...
			mv.setViewName("yibaoxuan/shanghuduan/release/releaseZone");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toContact() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd.put("state", "1");
			pd=ybxShangHuService.getDataOfContactUs(pd);
			mv.addObject("pd", pd);
			mv.addObject("shanghu_userId", getSessionUser().getUser_shanghu_id());
			mv.addObject("shanghu_name", getSessionUser().getUserName());
			mv.setViewName("yibaoxuan/shanghuduan/contact/connect");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toXianJinAmountApplyRecordDetail() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		pd=ybxShangHuService.getWithDrawCashById(pd);
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/shanghuduan/cash_amount/mingxi");
		return mv;
	}
	/**
	 * 进入个人中心-现金金额-申请记录页面
	...
	public ModelAndView toXianJinAmountApplyRecord() throws Exception{
		...
		if(isSession()){
			...
			//获取提现申请记录
			List<PageData> list=ybxShangHuService.getWithDrawCashList(pd);
			mv.addObject("list", list);
			System.out.println("+++++++++++++++++++++++++++++++list++"+list);
			mv.setViewName("yibaoxuan/shanghuduan/cash_amount/applyRecord");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView submitXianJinAmountApply() throws Exception{
		...
		if(isSession()){
			...
			shanghuPd=ybxShangHuService.getDataById(shanghuPd);
			...
			//保存提现申请记录
			ybxShangHuService.saveWithDrawCash(pd);
			
			//更新现金金额
			shanghuPd.put("xianjinAmount", balance_amount);
			ybxShangHuService.updateXianJinAmount(shanghuPd);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonXianJinAmount");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toXianJinAmountApply() throws Exception{
		...
		if(isSession()){
			...
			pd=ybxShangHuService.getDataById(pd);
			mv.addObject("xianjinAmount", pd.get("xianjinAmount"));
			mv.setViewName("yibaoxuan/shanghuduan/cash_amount/apply_cash");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toPersonXianJinAmount() throws Exception{
		...
		if(isSession()){
			...
			pd=ybxShangHuService.getDataById(pd);
			mv.addObject("pd", pd);
			mv.setViewName("yibaoxuan/shanghuduan/cash_amount/cash_home");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toPersonMyOrder() throws Exception{
		...
		if(isSession()){
			...
			list=ybxOrderService.getOrderOfYaoShang(pd);
			/*if(getSessionUser().getIdentity().equals("1")){
				list=ybxOrderService.getOrderOfYiSheng(pd);
			}else if(getSessionUser().getIdentity().equals("2")){
				list=ybxOrderService.getOrderOfJiGou(pd);
			}else{
				list=ybxOrderService.getOrderOfYaoShang(pd);
			}*/
			mv.addObject("list", list);
			mv.addObject("identity", getSessionUser().getIdentity());
			mv.setViewName("yibaoxuan/shanghuduan/my_order");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView updatePersonMyService(
		...
		if(isSession()){
			...
			//根据ID获取对象信息
			PageData pd=ybxShangHuService.getDataByIdOfService(dataPd);
			...
			ybxShangHuService.updateService(dataPd);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonMyService");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView deletePersonMyService() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd=this.getPageData();
			ybxShangHuService.deleteService(pd);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonMyService");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
	...
	public ModelAndView toPersonMyServiceEdit() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd=this.getPageData();
			pd=ybxShangHuService.getDataByIdOfService(pd);
			mv.addObject("pd", pd);
			mv.addObject("titleMsg", "编辑产品");
			
			if(getSessionUser().getIdentity().equals("1")){
				mv.addObject("msg", "updatePersonMyService");
				mv.setViewName("yibaoxuan/shanghuduan/addFuwu");
			}else{
				mv.addObject("msg", "updatePersonMyService1");
				mv.setViewName("yibaoxuan/shanghuduan/add_service");
			}
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
	...
	public ModelAndView savePersonMyServiceAdd(
		...
		if(isSession()){
			...
			pd.put("type", type);
			pd.put("user_shanghu_fid", getSessionUser().getUser_shanghu_id());
			ybxShangHuService.saveService(pd);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonMyService");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
	...
	public ModelAndView backToPersonMyServiceAdd() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd=this.getPageData();
			PageData tempPd=ybxShangHuService.getDataByIdOfService(pd);
	...
	public ModelAndView toPersonMyServiceAddJiBing() throws Exception{
		...
		if(isSession()){
			...
			if(pd.getString("msg").equals("savePersonMyServiceAdd")){
				...
				temp1.put("headImg", "");
				ybxShangHuService.updateService(temp1);
			}
			//查询疾病（默认查询字母a的疾病）
			PageData pd1=new PageData();
			pd1.put("letter", "a");
			List<PageData> list=ybxShangHuService.getJiBingListByLetter(pd1);
			//返回初始疾病集合
			mv.addObject("list", list);
	...
	public ModelAndView toPersonMyService() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd.put("user_shanghu_fid", getSessionUser().getUser_shanghu_id());
			List<PageData> serviceList=ybxShangHuService.getServiceList(pd);
			if(serviceList!=null && !serviceList.isEmpty()){
				for (int i = 0; i < serviceList.size(); i++) {
					...
					if (Tools.isEmpty(tempPd.getString("jibing_introdaction"))
						...
						ybxShangHuService.deleteService(tempPd);
			...
			mv.setViewName("yibaoxuan/shanghuduan/my_service");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toPersonMyJiFen() throws Exception{
		...
		if(isSession()){
			...
			pd=ybxShangHuService.getDataById(pd);
			//获取积分兑换股权的信息
			PageData tempPd=ybxShangHuService.getDataOfJiFenHuanGuQuan(pd);
	...
	public Object jiFenHuanGuQuan() throws Exception{
		...
		if(isSession()){
			...
			ybxShangHuService.updateJiFenAndGuQuan(pd);
	...
	public ModelAndView toChengJiaoInformation() throws Exception{
		...
		if(isSession()){
			...
			List<PageData> list=new ArrayList<PageData>();
			/*if(getSessionUser().getIdentity().equals("1")){
				list=ybxShangHuService.getChengJiaoJiLuList(pd);
			}else if(getSessionUser().getIdentity().equals("2")){
				list=ybxShangHuService.getChengJiaoJiLuList1(pd);
			}else{
				list=ybxShangHuService.getChengJiaoJiLuList2(pd);
			}*/
			list=ybxShangHuService.getChengJiaoJiLuList2(pd);
			mv.addObject("list", list);
			mv.addObject("identity", getSessionUser().getIdentity());
			mv.setViewName("yibaoxuan/shanghuduan/chengjiaoRecord");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toPersonShangHuMoney() throws Exception{
		...
		if(isSession()){
			...
			pd=ybxShangHuService.getDataById(pd);
			mv.addObject("pd", pd);
			mv.setViewName("yibaoxuan/shanghuduan/shanghuMoney");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView savePersonApplyStore(
		...
		if(isSession()){
			...
			if(imgFile.length>0 && imgFile[0].getSize()!=0){
				for (int i = 0; i < imgFile.length; i++) {
					if(imgFile[i]!=null && !imgFile[i].isEmpty()){
						...
						ybxShangHuService.saveApplyImgPath(tPd);
					}
				}
			}else{
			...
			ybxShangHuService.updateStateAndTime(temp);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonCenter");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toPersonApplyStore(){
		...
		ModelAndView mv=new ModelAndView();
		if(isSession()){
			mv.setViewName("yibaoxuan/shanghuduan/applyStore");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView saveSettingExampleAdd(
		...
		if(isSession()){
			...
			pd.put("addTime", DateUtil.getTime());
			pd.put("user_shanghu_fid", getSessionUser().getUser_shanghu_id());
			ybxShangHuService.saveAnLiInformation(pd);
	...
	public ModelAndView saveSettingExampleEdit(
		...
		if(isSession()){
			...
			pd=ybxShangHuService.getAnLiDataById(pd);
			...
			pd.put("title", title);
			pd.put("detailContent", detailContent);
			ybxShangHuService.updateAnLiInformation(pd);
			mv.setViewName("redirect:/api/shangHu/toSettingExample");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
	...
	public ModelAndView deleteSettingExample() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd=this.getPageData();
			ybxShangHuService.deleteAnLiById(pd);
			mv.setViewName("redirect:/api/shangHu/toSettingExample");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
	...
	public ModelAndView toSettingExample() throws Exception{
		...
		if(isSession()){
			PageData pd=new PageData();
			pd.put("user_shanghu_fid", getSessionUser().getUser_shanghu_id());
			List<PageData> list=ybxShangHuService.getAnLiList(pd);
			mv.addObject("list", list);
	...
	public ModelAndView saveSettingGoodField() throws Exception{
		...
		if(isSession()){
			...
			ybxShangHuService.updatePersonIntroductOrGoodsField(pd);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonCenterSetting");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toSettingGoodField() throws Exception{
		...
		if(isSession()){
			...
			PageData pd=ybxShangHuService.getDataByIdAndIdentity(tempPd);
			mv.addObject("pd", pd);
			mv.setViewName("yibaoxuan/shanghuduan/goodAtArea");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toSettingPersonIntroduct(HttpSession session) throws Exception{
		...
		if(isSession()){
			...
			PageData pd=ybxShangHuService.getDataByIdAndIdentity(tempPd);
			mv.addObject("pd", pd);
			mv.setViewName("yibaoxuan/shanghuduan/persJianjie");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView savePersonInformation(
		...
		if(isSession()){
			...
			//根据ID获取对象信息
			PageData pd=ybxShangHuService.getDataByIdAndIdentity(dataPd);
			if(headImgFile!=null && !headImgFile.isEmpty()){
				//原有头像如果存在，则删除
				if(Tools.notEmpty(pd.getString("headImg"))){
					FileUtil.delFile(PathUtil.getClasspath()+pd.getString("headImg"));
				...
				//更新用户二维码
				ybxShangHuService.updateErWeiMa(dataPd);*/
			}else{
				dataPd.put("headImg", pd.getString("headImg"));
			}
			...
			ybxShangHuService.updatePersonInformation(dataPd);
			mv.setViewName("redirect:/api/ybxshangHu/toPersonCenterSetting");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
	...
	public ModelAndView toSettingPersonInformationKeLei(
		...
		if(isSession()){
			...
			dataPd.put("user_shanghu_id", getSessionUser().getUser_shanghu_id());
			//根据ID获取对象信息
			PageData pd=ybxShangHuService.getDataById(dataPd);
			if(headImgFile!=null && !headImgFile.isEmpty()){
				//原有头像如果存在，则删除
				if(Tools.notEmpty(pd.getString("headImg"))){
					FileUtil.delFile(PathUtil.getClasspath()+pd.getString("headImg"));
			...
			//获取顶级科室的名称列表
			pd.put("parent_id", "0");
			List<PageData> listtop=ybxShangHuService.getkeLeiList(pd);
			//获取第一个顶级科室下的子科类
			pd.put("parent_id", listtop.get(0).getString("kelei_id"));
			List<PageData> listchild=ybxShangHuService.getkeLeiList(pd);
	...
	public ModelAndView toSettingPersonInformation() throws Exception{
		...
		if(isSession()){
			...
			/*if(getSessionUser().getIdentity().equals("1")){
				mv.setViewName("yibaoxuan/shanghuduan/persXinxi1");
			}else{
				if(getSessionUser().getIdentity().equals("2")){
					List<PageData> list=ybxShangHuService.getJiGouTypeList(tempPd);
					mv.addObject("list", list);
				}
				mv.setViewName("yibaoxuan/shanghuduan/persXinxi1");
			}*/
	...
	public ModelAndView toPersonCenterSetting(){
		...
		ModelAndView mv=new ModelAndView();
		if(isSession()){
			mv.setViewName("yibaoxuan/shanghuduan/personalData");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public ModelAndView toPersonCenter() throws Exception{
		...
		if(isSession()){
			...
			tempPd.put("identity", getSessionUser().getIdentity());
			PageData pd=ybxShangHuService.getDataByIdAndIdentity(tempPd);
			List<PageData> list=ybxShangHuService.getServiceList(tempPd);
			mv.addObject("pd", pd);
			mv.addObject("list", list);
			mv.addObject("tempPd", tempPd);
			mv.setViewName("yibaoxuan/shanghuduan/center_home");
		}else{
			mv.setViewName("redirect:/api/shangHu/toLogin");
		}
		return mv;
	...
	public Object isPerfectPersonInformation() throws Exception{
		...
		PageData pd1=ybxShangHuService.getDataByIdAndIdentity(pd);
	...
	public Object isStateApplyStore() throws Exception{
		...
		pd.put("user_shanghu_id", shangHu.getUser_shanghu_id());
		pd.put("identity", shangHu.getIdentity());
		pd=ybxShangHuService.getDataByIdAndIdentity(pd);
	...
	public ModelAndView toRegister(){
		...
		ModelAndView mv=new ModelAndView();
		mv.setViewName("yibaoxuan/shanghuduan/register");
		return mv;
	}
	/**
	 * 注册
	...
	public Object register(HttpServletRequest request) throws Exception{
		...
		//根据用户名或者手机号查询对象信息
		PageData tempUserName=ybxShangHuService.getDataByNameOrPhone(pdUserName);
		PageData tempPhone=ybxShangHuService.getDataByNameOrPhone(pdPhone);
		...
		if(tempUserName!=null){//该用户名已经存在
			...
			if(tempPhone!=null){//该手机号已经注册
				...
				if(rMap.get("code").equals("414")){
					...
					pd.put("token", "");
					//获取注册送积分
					pd.put("integral", ybxShangHuService.getDataOfJiFenZhuCe(pd).get("jifen_zhuce_number"));
					//获取注册送虚拟币
					pd.put("xunibi", ybxShangHuService.getDataOfXuNiBi(pd).get("xunibi_number"));
					//获取注册送股权
					pd.put("guquan", ybxShangHuService.getDataOfGuQuan(pd).get("guquan_number"));
					ybxShangHuService.saveShangHu(pd);
					...
					djpd.put("erji_id", "");
					djpd.put("type", "2");
					ybxKeHuService.saveFenXiao(djpd);
				}
	...
	public Object toLoginMissPassword3() throws Exception{
		...
		String respMsg="";
		//验证该手机号是否已经注册
		PageData tpd=ybxShangHuService.getDataByNameOrPhone(pd);
		if(tpd==null){
			respMsg="该手机号尚未注册!";
		}else{
			PageData tempPd=new PageData();
			...
			ybxShangHuService.updatePasswordByPhone(tempPd);
			respMsg="修改成功";
			respCode = "01";
		}
		map.put("respMsg", respMsg);
	...
	public ModelAndView toLoginMissPassword2(){
		...
		if(pd==null){
			...
			mv.setViewName("yibaoxuan/shanghuduan/newPass");
		}
		return mv;
	}
	...
	public ModelAndView toLoginMissPassword1(){
		...
		ModelAndView mv=new ModelAndView();
		mv.setViewName("yibaoxuan/shanghuduan/searchPass");
		return mv;
	}
	...
	public ModelAndView toLogin(){
		...
		pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/shanghuduan/login");
		return mv;
	}
	/**
	 * 退出登录
	...
	public Object login(HttpSession session,HttpServletRequest request) throws Exception{
		...
		tempPd.put("identity", pd.getString("identity"));
		//判断该用户名或者手机号是否在该平台注册
		PageData pdTemp=ybxShangHuService.getDataByNameOrPhone(tempPd);
		if(pdTemp==null){
			respMsg="用户不存在";
		}else{
			PageData tempData=ybxShangHuService.getDataByNameAndPawAndIdentity(tempPd);
			if(tempData!=null){
				respCode="01";
				respMsg="登录成功";
				//创建session
				...
				ybxShangHuService.updateIpAndTime(temp);
	...
	public void createSession(String user_shanghu_id) throws Exception{
		...
		PageData tempData=ybxShangHuService.getDataByNameOrPhone(pd);
		ShangHu shangHu=new ShangHu();
		shangHu.setUser_shanghu_id(tempData.getString("user_shanghu_id"));
		shangHu.setPhone(tempData.getString("phone"));
		shangHu.setUserName(tempData.getString("userName"));
...
///////////////////////////////////////////////////////////医生部分////网站后台功能//////////////////////////////////
	...
	public ModelAndView getyishenglistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ybxShangHuService.getyishenglistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		...
		mv.setViewName("yibaoxuan/yishengList/yishengList_list");
		return mv;
	}
	/**
	 * 认证审核操作
	...
	public void yishengChenked(PrintWriter writer) throws Exception{
		...
		ybxShangHuService.yishengChenked(map);
		writer.close();
	}
	/**
	 * 改变账号状态操作
	...
	public void yishengStatus(PrintWriter writer) throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		ybxShangHuService.yishengStatus(pd);
		writer.close();
	}
	/**
	 * 获取基本信息
	...
	public Object getRenZhengInformation() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		List<PageData> list=ybxShangHuService.getRenZhengInformation(pd);
		map.put("list", list);
	...
	public ModelAndView getyishengfuwulistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ybxShangHuService.getyishengfuwulistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/yishengfuwuList/yishengfuwuList_list");
		return mv;
	}
	/**
	 * 根据ID获取服务的详情
	...
	public Object getYiShengServiceDetailInformation() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		pd=ybxShangHuService.getDataByIdOfService1(pd);
		map.put("pd", pd);
		System.out.println("获取基本信息pd:"+pd);
 		return AppUtil.returnObject(pd, map);
	}
	...
	public void topShangHu(PrintWriter writer) throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		ybxShangHuService.topShangHu(pd);
		writer.close();
	}
...
///////////////////////////////////////////////////////////系统管理:联系我们////网站后台功能//////////////////////////////////
	...
	public ModelAndView contactuslistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ybxShangHuService.contactuslistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/contactus/contactus_list");
		return mv;
	}
	/**
	 * 进入联系我们添加页
	...
	public ModelAndView toAddContactUs(){
		...
		mv.setViewName("yibaoxuan/contactus/contactus_edit");
		return mv;
	}
	/**
	 * 添加联系我们
	...
	public ModelAndView insertContactUs() throws Exception{
		...
		ybxShangHuService.insertContactUs(pd);
	...
	public ModelAndView toEditContactUs() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		pd=ybxShangHuService.getContactUsById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateContactUs() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		ybxShangHuService.updateContactUs(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteContactUsById(PrintWriter writer) throws Exception{
		...
		map.put("ids", ids);
		ybxShangHuService.deleteContactUsById(map);
		writer.close();
	}
///////////////////////////////////////////////////////////新闻公告////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getnewsandnoticelistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ybxShangHuService.getnewsandnoticelistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/newsandnotice/newsandnotice_list");
		return mv;
	}
	/**
	 * 获取新闻公告的详情
	...
	public Object getNewsAndNoticeDetaileInformation() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		pd=ybxShangHuService.getNewsAndNoticeById(pd);
		map.put("pd", pd);
		return AppUtil.returnObject(pd, map);
	}
	/**
	...
	public ModelAndView toAddNewsAndNotice(){
		...
		mv.setViewName("yibaoxuan/newsandnotice/newsandnotice_edit");
		return mv;
	}
	/**
	 * 添加新闻公告
	...
	public ModelAndView insertNewsAndNotice(
		...
		pd.put("top", "0");
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.insertNewsAndNotice(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView updateNewsAndNotice(
		...
		PageData temp=ybxShangHuService.getNewsAndNoticeById(pd);
		if(imgPthFile!=null && !imgPthFile.isEmpty()){
		...
		pd.put("origin", origin);
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.updateNewsAndNotice(pd);
		mv.addObject("msg","success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteNewsAndNoticeById(PrintWriter writer) throws Exception{
		...
		map.put("ids", ids);
		ybxShangHuService.deleteNewsAndNoticeById(map);
		writer.close();
	}
	...
	public void topNewsAndNotice(PrintWriter writer) throws Exception{
		...
		pd=this.getPageData();
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.topNewsAndNotice(pd);
		writer.close();
	}
///////////////////////////////////////////////////////////常见疾病////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getjibinglistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getjibinglistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/changjianjibing/changjianjibing_list");
		return mv;
	}
	/**
	 * 判断该疾病名称是否存在
	...
	public Object isNameOfJiBingExistence() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		PageData tempPd=ybxShangHuService.getJiBingByName(pd);
		String reqCode="00";
	...
	public ModelAndView toAddJiBing() {
		...
		mv.setViewName("yibaoxuan/changjianjibing/changjianjibing_edit2");
		return mv;
	}
	...
	public Object getJiBingListByLetter() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		List<PageData> list=ybxShangHuService.getJiBingListByLetter(pd);
		map.put("list", list);
		return AppUtil.returnObject(pd, map);
	}
	...
	public ModelAndView insertJiBing()throws Exception {
		...
		ybxShangHuService.insertJiBing(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditJiBing() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getJiBingById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateJiBing()throws Exception {
		...
		ybxShangHuService.updateJiBing(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteJiBingById(PrintWriter writer) throws Exception {
		...
		map.put("ids", ids);
		ybxShangHuService.deleteJiBingById(map);
		writer.close();
	}
///////////////////////////////////////////////////////////科类名称////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView keleilistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.keleilistPage(page);
		mv.addObject("list", list);
	...
	public Object getkeLeiList() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		List<PageData> list = ybxShangHuService.getkeLeiList(pd);
		map.put("list", list);
		return AppUtil.returnObject(pd, map);
	}
	/**
	...
	public Object isNameOfKeLeiExistence() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		PageData tempPd = ybxShangHuService.getKeLeiByNameAndParentid(pd);
		String reqCode = "00";
	...
	public ModelAndView insertKeLei() throws Exception {
		...
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.insertKeLei(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditKeLei() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getKeLeiById(pd);
		mv.addObject("pd", pd);
		PageData tempPd=new PageData();
		tempPd.put("parent_id", "0");
		List<PageData> list=ybxShangHuService.getkeLeiList(tempPd);
		mv.addObject("list", list);
	...
	public ModelAndView updateKeLei() throws Exception {
		...
		pd = this.getPageData();
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.updateKeLei(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteKeLeiById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd=this.getPageData();
		PageData temp=ybxShangHuService.getKeLeiById(pd);
		if(temp.getString("parent_id").equals("0")){
			pd.put("parent_id", pd.getString("kelei_id"));
			ybxShangHuService.deleteKeLeiById(pd);
			ybxShangHuService.deleteKeLeiByParentid(pd);
		}else{
			ybxShangHuService.deleteKeLeiById(pd);
		}
		writer.close();
...
// /////////////////////////////////////////////////////////会员部分////网站后台功能//////////////////////////////////
	...
	public ModelAndView gethuiyuanlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.gethuiyuanlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/huiyuanList/huiyuanList_list");
		return mv;
	}
	/**
	 * 改变账号状态操作
	...
	public void huiyuanStatus(PrintWriter writer) throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		ybxShangHuService.huiyuanStatus(pd);
		writer.close();
	}
	/**
	 * 获取需求列表
	...
	public ModelAndView getxuqiulistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getxuqiulistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/xuqiuList/xuqiuList_list");
		return mv;
	}
	/**
	 * 根据需求表的主键ID获取对应的需求图片
	...
	public Object getxuqiuimgList() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		List<PageData> list = ybxShangHuService.getxuqiuimgList(pd);
...
///////////////////////////////////////////////////////////注册送积分////网站后台功能//////////////////////////////////
	...
	public ModelAndView getjifenzhucelistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getjifenzhucelistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/jifenzhuce/jifenzhuce_list");
		return mv;
	}
	...
	public ModelAndView toAddJiFenZhuCe() {
		...
		mv.setViewName("yibaoxuan/jifenzhuce/jifenzhuce_edit");
		return mv;
	}
	...
	public ModelAndView insertJiFenZhuCe() throws Exception {
		...
		ybxShangHuService.insertJiFenZhuCe(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditJiFenZhuCe() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getJiFenZhuCeById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateJiFenZhuCe() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateJiFenZhuCe(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteJiFenZhuCeById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd=this.getPageData();
		ybxShangHuService.deleteJiFenZhuCeById(pd);
		writer.close();
	}
///////////////////////////////////////////////////////////技术费用扣除比例////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getjishufuwubililistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getjishufuwubililistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/jishufuwubili/jishufuwubili_list");
		return mv;
	}
	...
	public ModelAndView toAddJiShuFuWuBiLi() {
		...
		mv.setViewName("yibaoxuan/jishufuwubili/jishufuwubili_edit");
		return mv;
	}
	...
	public ModelAndView insertJiShuFuWuBiLi() throws Exception {
		...
		ybxShangHuService.insertJiShuFuWuBiLi(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditJiShuFuWuBiLi() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getJiShuFuWuBiLiById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateJiShuFuWuBiLi() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateJiShuFuWuBiLi(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteJiShuFuWuBiLiById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.deleteJiShuFuWuBiLiById(pd);
		writer.close();
	}
	...
	public ModelAndView getjifenlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getjifenlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/jifenfenxiao/jifenfenxiao_list");
		return mv;
	}
	...
	public ModelAndView insertJiFen() throws Exception {
		...
		ybxShangHuService.insertJiFen(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditJiFen() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getJiFenById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateJiFen() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateJiFen(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteJiFenById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.deleteJiFenById(pd);
		writer.close();
	}
	// /////////////////////////////////////////////////////////分销管理：提成设置////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getfenxiaobililistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getfenxiaobililistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/bilifenxiao/bilifenxiao_list");
		return mv;
	}
	...
	public ModelAndView insertFenXiaoBiLi() throws Exception {
		...
		ybxShangHuService.insertFenXiaoBiLi(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditFenXiaoBiLi() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getFenXiaoBiLiById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateFenXiaoBiLi() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateFenXiaoBiLi(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteFenXiaoBiLiById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.deleteFenXiaoBiLiById(pd);
		writer.close();
	}
///////////////////////////////////////////////////////////名著管理////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getmingzhulistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getmingzhulistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/mingzhu/mingzhu_list");
		return mv;
	}
	...
	public Object isNameOfMingZhuExistence() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		PageData tempPd = ybxShangHuService.getMingZhuByName(pd);
		String reqCode = "00";
	...
	public ModelAndView insertMingZhu(
		...
		ybxShangHuService.insertMingZhu(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditMingZhu() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getMingZhuById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateMingZhu(
		...
		PageData temp=ybxShangHuService.getMingZhuById(pd);
		if(imgPathFile!=null && !imgPathFile.isEmpty()){
		...
		pd.put("mingzhuLink", mingzhuLink);
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.updateMingZhu(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteMingZhuById(PrintWriter writer) throws Exception {
		...
		map.put("ids", ids);
		ybxShangHuService.deleteMingZhuById(map);
		writer.close();
	}
///////////////////////////////////////////////////////////注册送股权////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getguquanlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getguquanlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/guquanzhuce/guquanzhuce_list");
		return mv;
	}
	...
	public ModelAndView toAddGuQuan() {
		...
		mv.setViewName("yibaoxuan/guquanzhuce/guquanzhuce_edit");
		return mv;
	}
	...
	public ModelAndView insertGuQuan() throws Exception {
		...
		ybxShangHuService.insertGuQuan(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditGuQuan() throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getGuQuanById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateGuQuan() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateGuQuan(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteGuQuanById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.deleteGuQuanById(pd);
		writer.close();
	}
///////////////////////////////////////////////////////////注册送虚拟币////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getxunibilistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getxunibilistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/xunibizhuce/xunibizhuce_list");
		return mv;
	}
	...
	public ModelAndView toAddXuNiBi() {
		...
		mv.setViewName("yibaoxuan/xunibizhuce/xunibizhuce_edit");
		return mv;
	}
	...
	public ModelAndView insertXuNiBi() throws Exception {
		...
		ybxShangHuService.insertXuNiBi(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditXuNiBi() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getXuNiBiById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateXuNiBi() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateXuNiBi(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteXuNiBiById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.deleteXuNiBiById(pd);
		writer.close();
	}
///////////////////////////////////////////////////////////提现管理////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView getWithDrawCashlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getSHWithDrawCashlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/withdrawcashSH/withdrawcashSH_list");
		return mv;
	}
	/**
	 * 获取客户端提现列表
	...
	public ModelAndView getKHWithDrawCashlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getKHWithDrawCashlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/withdrawcashKH/withdrawcashKH_list");
		return mv;
	}
	/**
	 * 改变提现状态
	...
	public ModelAndView updateWithDrawCashState(
		...
		ybxShangHuService.updateWithDrawCashState(pd);
		if(type.equals("1")){
...
///////////////////////////////////////////////////////////机构类型////网站后台功能//////////////////////////////////
	...
	public ModelAndView getjigoulistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getjigoulistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
	...
	public Object isNameOfJiGouTypeExistence() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		PageData tempPd = ybxShangHuService.getJiGouTypeByName(pd);
		String reqCode = "00";
		String reqMsg = "该名称已存在";
		if (tempPd == null) {
			reqCode = "01";
	...
	public ModelAndView insertJiGouType() throws Exception {
		...
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.insertJiGouType(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditJiGouType() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getJiGouTypeById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateJiGouType() throws Exception {
		...
		pd = this.getPageData();
		pd.put("addTime", DateUtil.getTime());
		ybxShangHuService.updateJiGouType(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteJiGouTypeById(PrintWriter writer) throws Exception {
		...
		map.put("ids", ids);
		ybxShangHuService.deleteJiGouTypeById(map);
		writer.close();
	}
...
///////////////////////////////////////////////////////////积分兑换股权////网站后台功能//////////////////////////////////
	...
	public ModelAndView getjifenhuanguquanlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.getjifenhuanguquanlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/jifenhuanguquan/jifenhuanguquan_list");
		return mv;
	}
	...
	public ModelAndView toAddJiFenHuanGuQuan() {
		...
		mv.setViewName("yibaoxuan/jifenhuanguquan/jifenhuanguquan_edit");
		return mv;
	}
	...
	public ModelAndView insertJiFenHuanGuQuan() throws Exception {
		...
		ybxShangHuService.insertJiFenHuanGuQuan(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditJiFenHuanGuQuan() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getJiFenHuanGuQuanById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateJiFenHuanGuQuan() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateJiFenHuanGuQuan(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteJiFenHuanGuQuanById(PrintWriter writer) throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.deleteJiFenHuanGuQuanById(pd);
		writer.close();
	}
	...
	public ModelAndView fenxiaoMoney() throws Exception{
		...
		pd.put("type", "2");
		List<PageData> fenxiaoMoneyList =  ybxKeHuService.selectFenxiaoMoenyList(pd);
...
//////////////////////////////////////////////////////////退单部分//////////////////////////////////
	...
	public ModelAndView tuidanlistPage(Page page) throws Exception {
		...
		List<PageData> list = new ArrayList<PageData>();
		if(pd.getString("identity").equals("1")){
			list = ybxShangHuService.tuidanw1listPage(page);
		}else if(pd.getString("identity").equals("2")){
			list = ybxShangHuService.tuidanw2listPage(page);
		}else{
			list = ybxShangHuService.tuidanw3listPage(page);
		}
		
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/tuidan/tuidan_list");
		return mv;
	}	
	...
	public ModelAndView updateTuiDan() throws Exception {
		...
		if(pd.getString("identity").equals("1")){
			ybxShangHuService.updateTuiDan1(pd);
		}else if(pd.getString("identity").equals("2")){
			ybxShangHuService.updateTuiDan2(pd);
		}else{
			ybxShangHuService.updateTuiDan3(pd);
		}
		ybxShangHuService.updateJiFenHuanGuQuan(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
	...
	public ModelAndView updateTuiDan0() throws Exception {
		...
		mv.setViewName("redirect:/api/ybxkehu/huiyuanzhongxin");
		return mv;
	}
///////////////////////////////////////////////////////////存款利率设置////网站后台功能//////////////////////////////////
	/**
	...
	public ModelAndView cunkuanlilvlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxShangHuService.cunkuanlilvlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/cunkuanlilv/cunkuanlilv_list");
		return mv;
	}
	...
	public ModelAndView toAddCunKuanLiLv() {
		...
		mv.setViewName("yibaoxuan/cunkuanlilv/cunkuanlilv_edit");
		return mv;
	}
	...
	public ModelAndView insertCunKuanLiLv() throws Exception {
		...
		ybxShangHuService.insertCunKuanLiLv(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public ModelAndView toEditCunKuanLiLv() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxShangHuService.getCunKuanLiLvById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateCunKuanLiLv() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		ybxShangHuService.updateCunKuanLiLv(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteCunKuanLiLvById(PrintWriter writer) throws Exception {
		...
		map.put("ids", ids);
		ybxShangHuService.deleteCunKuanLiLvById(map);
		writer.close();
	}
///////////////////////////////////////////////////////////存款//////////////////////////////////////
	/**
	...
	public ModelAndView getCunKuanList() throws Exception {
		...
		ybxShangHuService.updateCunKuanState(pd);
		//if(isSession()){
			//获取列表信息
			pd.put("user_id", getSessionUser().getUser_shanghu_id());
			List<PageData> list=ybxShangHuService.getCunKuanList(pd);
			mv.addObject("list", list);
		//}else{
			//mv.setViewName("redirect:/api/shangHu/toLogin");
		//}
		...
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/shanghuduan/cunkuanlist");
		return mv;
	}
	/**
	 * 进入选择存款类型页面
	...
	public ModelAndView toCunKuan() throws Exception {
		...
		PageData shanghuPd=ybxShangHuService.getDataById(pd);
		if(shanghuPd!=null){//为商户
			pd.put("amount", shanghuPd.get("xianjinAmount"));
		}else{//为客户
			pd.put("user_kuhu_id", pd.getString("user_id"));
			PageData kehuPd=ybxKeHuService.getDetailByID(pd);
			pd.put("amount", kehuPd.get("money"));
		}
		pd2 = ybxShangHuService.getDataOfCunKuanLiLv(shanghuPd);
		mv.addObject("pd", pd);
		mv.addObject("pd2", pd2);
		mv.setViewName("yibaoxuan/shanghuduan/cunkuan");
		return mv;
	}
	...
	public ModelAndView insertCunKuan() throws Exception {
		...
		//获取利率
		int month=0;
		PageData lilvPd=ybxShangHuService.getDataOfCunKuanLiLv(pd);
		//1,2存款记录的利率和存款类型
		...
		if(shanghuPd!=null){//为商户
			...
			ybxShangHuService.updateXianJinAmount(pd);
		}else{//为客户
			pd.put("user_kuhu_id", pd.getString("user_id"));
			...
			ybxKeHuService.updateMoneyBykehuID(pd);
		...
		//10状态
		temppd.put("state", "2");
		ybxShangHuService.insertCunKuan(temppd);
		mv.setViewName("redirect:/api/ybxshangHu/getCunKuanList?user_id="+pd.getString("user_id"));
		return mv;
	}
	/**
	 * 取出到余额
	...
	public Object quchudaoyue() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		pd=ybxShangHuService.getCunKuanOfId(pd);
		...
		ybxShangHuService.updateCunKuanState1(pd);
		return AppUtil.returnObject(pd, map);
	}
