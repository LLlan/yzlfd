 ...
 */
@Controller
@RequestMapping(value="/api/ybxkehu")
public class YbxKeHuController extends BaseController{
	...
	public ModelAndView transfer() throws Exception {
		...
		pd = this.getPageData();
		mv.setViewName("yibaoxuan/kehuduan/transfer");
		return mv;
	}
	...
	public ModelAndView pingjiajilu() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		List<PageData> list = ybxKeHuService.pingjiajiluList(pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/kehuduan/user/region/pingjiaRecord");
		return mv;
	}
	...
	public ModelAndView myqq() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("yibaoxuan/kehuduan/user/region/lijizixun");
		return mv;
	}
	...
	public ModelAndView shangjiaRegister() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		mv.setViewName("yibaoxuan/kehuduan/user/region/shangjiaRegister");
		return mv;
	}
	...
	public ModelAndView goDownAPK(HttpServletRequest request) throws Exception{
	    ...
	    mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/downAPK");
		return mv;
	}
	...
	public ModelAndView goDownShangjiaAPK(HttpServletRequest request) throws Exception{
		...
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/region/downShangjiaAPK");
		return mv;
	}
	...
	public ModelAndView toTixian() throws Exception{
		...
		if(isSession()){
			...
			mv.setViewName("yibaoxuan/kehuduan/apply_cash");
		}else{
			mv.setViewName("redirect:/api/ybxkehu/toLogin");
		}
		return mv;
	}
	...
	public ModelAndView submitXianJinAmountApply() throws Exception{
		...
		if(isSession()){
			...
			kehuPd=ybxKeHuService.getMoneyBykehuID(kehuPd);
			...
			kehuPd.put("user_kehu_id", getSessionUser().getUser_kuhu_id());
			ybxKeHuService.updateMoneyBykehuID(kehuPd);
			mv.setViewName("redirect:/api/ybxkehu/myMoney");
		}else{
			mv.setViewName("redirect:/api/ybxkehu/toLogin");
		}
		return mv;
	...
	public ModelAndView toXianJinAmountApplyRecord() throws Exception{
		...
		if(isSession()){
			...
			mv.addObject("list", list);
			mv.setViewName("yibaoxuan/cash_amount/applyRecord");
	...
	public ModelAndView toXianJinAmountApplyRecordDetail() throws Exception{
		...
		ModelAndView mv=new ModelAndView();
			...
			mv.addObject("pd", pd);
			mv.setViewName("yibaoxuan/cash_amount/mingxi");
			return mv;
	}
	...
	public Object getDoctorListByAddress() throws Exception{
		...
		//List<PageData> doctorList =  ybxKeHuService.getDoctorListByAddress(pd);
		List<PageData> doctorList =  ybxKeHuService.getyishengList(pd);
	...
	public ModelAndView login_toLogin()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd.put("SYSNAME", Tools.readTxtFile(Const.SYSNAME_YBX)); //读取系统名称
	...
	public Object getDiseaseByZimu() throws Exception{
		...
		List<PageData> diseaseList = ybxKeHuService.getDiseaseListByZimu(pd);
	...
	public Object getYnzzListByZimu() throws Exception{
		...
		Map map = new HashMap();
		System.out.println("---------"+pd.get("zimu"));
		List<PageData> diseaseList = ybxKeHuService.getYnzzListByZimu(pd);
		map.put("diseaseList", diseaseList);
		map.put("respCode", "01");
		return AppUtil.returnObject(pd, map);
	}
	...
	public ModelAndView barrage(){
		...
		ModelAndView mv=new ModelAndView();
		mv.setViewName("yibaoxuan/kehuduan/barrage/sendMessage");
		return mv;
	}
	...
	public ModelAndView index(Page page) throws Exception{
		...
		//轮播图列表
		pd.put("tidImg", "1");
		List<PageData> bannerList = ybxKeHuService.getBannerImagesList(pd);
		mv.addObject("bannerList", bannerList);
		//医生列表
		pd.put("type", "7");
		List<PageData> yishengList = ybxKeHuService.getyishengList(pd);
		Collections.shuffle(yishengList);
		mv.addObject("yishengList", yishengList);
		
		//疾病列表
		List<PageData> jibinglist = ybxShangHuService.getjibinglistPage(page);
		mv.addObject("jibinglist", jibinglist);
		
		//新闻列表
		List<PageData> xinwenlist=ybxShangHuService.getnewsandnoticelistPage(page);
		mv.addObject("xinwenlist", xinwenlist);
		
		//公告列表
		List<PageData> gonggaolist=ybxShangHuService.getnewsandnoticelistPage(page2);
		mv.addObject("gonggaolist", gonggaolist);
		
		//名著列表
		List<PageData> mingzhulist=ybxShangHuService.getMingzhuList(page2);
		...
		//机构列表
		pd.put("type", "9");
		List<PageData> jigouList = ybxKeHuService.getyishengList(pd);
		Collections.shuffle(jigouList);
		mv.addObject("jigouList", jigouList);
		//机构列表
		pd.put("type", "10");
		List<PageData> jigouList1 = ybxKeHuService.getyishengList(pd);
		Collections.shuffle(jigouList1);
		mv.addObject("jigouList1", jigouList1);
		mv.addObject("twoDimensioncode_id", pd.get("twoDimensioncode_id"));
		mv.setViewName("yibaoxuan/kehuduan/index");
		return mv;
	}
	...
	public ModelAndView showChangjianjibingDetailByID() throws Exception{
		...
		PageData pd  = new PageData();
		pd = this.getPageData();
		PageData cjjbData = ybxKeHuService.showChangjianjibingDetailByID(pd);
		mv.addObject("cjjbData", cjjbData);
		mv.setViewName("yibaoxuan/kehuduan/news/changjianjibingDetail");
		return mv;
	}
	...
	public ModelAndView showYnzzDetailByID() throws Exception{
		...
		PageData pd  = new PageData();
		pd = this.getPageData();
		PageData cjjbData = ybxKeHuService.showYnzzDetailByID(pd);
		mv.addObject("cjjbData", cjjbData);
		mv.setViewName("yibaoxuan/kehuduan/news/ynzzDetail");
		return mv;
	}
	...
	public ModelAndView getXinwenDetail() throws Exception{
		...
		PageData pd  = new PageData();
		pd = this.getPageData();
		PageData xgData  = ybxKeHuService.getXinwenDetail(pd);
		mv.addObject("xgData",xgData);
		mv.setViewName("yibaoxuan/kehuduan/news/artical");
		return mv;
	}
	...
	public ModelAndView getYishengDetail(HttpSession session) throws Exception{
		...
		if(isSession()){
			...
			mv.addObject("msg", "session有效");
			//医生详情列表
			PageData xqData  = ybxKeHuService.getYishengDetail(pd);
			mv.addObject("xqData",xqData);
			
			//服务列表
			List<PageData> fuwuList = ybxKeHuService.getyishengFuwuList(pd);
			mv.addObject("fuwuList",fuwuList);
			
			//案例列表
			//List<PageData> anliList = ybxKeHuService.getyishengAnliList(pd);
		...
		mv.setViewName("yibaoxuan/kehuduan/user/region/regin_info");
		return mv;
	}
	...
	public ModelAndView getyishengAnliDetail() throws Exception{
		...
		PageData pd  = new PageData();
		pd = this.getPageData();
		PageData anliData  = ybxKeHuService.getYishengAnliDetail(pd);
		mv.addObject("anliData",anliData);
		mv.setViewName("yibaoxuan/kehuduan/user/region/case_detail");
		return mv;
	}
	...
	public ModelAndView fabuxuqiuList() throws Exception{
		...
		if(isSession()){
			...
			List<PageData> xuqiuList  = ybxKeHuService.selectXuqiuList(pd);
		...
		mv.setViewName("yibaoxuan/kehuduan/release/releaseZone");
		return mv;
	}
	...
	public ModelAndView yishengList() throws Exception{
		...
		List<PageData> yishengList =  ybxKeHuService.getyishengList(pd);
		mv.addObject("yishengList", yishengList);
		mv.setViewName("yibaoxuan/kehuduan/user/region/regin_home1.jsp");
		return mv;
	}
	...
	*/
	...
	public ModelAndView fabuxuqiu(){
		...
		mv.setViewName("yibaoxuan/kehuduan/release/releaseNeeds");
		return mv;
	}
	...
	public ModelAndView tofabuxuqiu() throws Exception{
		...
		if(isSession()){
			...
			mv.addObject("respCode", "01");
			mv.addObject("msg", "session有效");
			pd=ybxKeHuService.getDataOfXuQiuById(pd);
			...
			List<PageData> imgList=ybxKeHuService.getImgsByXuqiuID(pd1);
	...
	public Object deleteXuQiuImgById() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		ybxKeHuService.deleteXuQiuImgById(pd);
		return AppUtil.returnObject(pd, map);
	}
	...
	public ModelAndView updateXuqiu(
		...
		if(imgFile.length>0 && imgFile[0].getSize()!=0){
			...
			//ybxKeHuService.deleteXuQiuImg(pd);
			System.out.println("-------图片对象----"+imgFile[0].getContentType());
				for(int i=0;i<imgFile.length;i++){
					...
					ybxKeHuService.saveXuqiuImgs(pd);
				}
		...
		ybxKeHuService.updateXuqiu(pd);
		
		mv.setViewName("redirect:/api/ybxkehu/fabuxuqiuList");
		return mv;
	}
	...
	public ModelAndView yinanzazheng(){
		...
		mv.setViewName("yibaoxuan/kehuduan/disease/yinanzazheng");
		return mv;
	}
	/**
	 * 底栏-常见疾病
	...
	public ModelAndView changjianjibing() throws Exception{
		...
		mv.setViewName("yibaoxuan/kehuduan/disease/changjianDisease");
		return mv;
	}
	...
	public ModelAndView connectUs() throws Exception{
		...
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/contact/connect");
		return mv;
	}
	...
	public ModelAndView huiyuanzhongxin() throws Exception{
		...
		if(isSession()){
			...
			//查用户订单
			//List<PageData> yishengOrderList =  ybxKeHuService.getYishengOrderList(pd2);
			List<PageData> yaoshangOrderList =  ybxKeHuService.getYaoshangOrderList(pd2);
			//List<PageData> jigouOrderList =  ybxKeHuService.getjigouOrderList(pd2);
			...
			/*pd.put("user_kuhu_fid", zywKeHu.getUser_kuhu_id());
			List<PageData> taskList =  ybxKeHuService.getTimingTaskList(pd);
		...
		mv.setViewName("yibaoxuan/kehuduan/user/waitDo");
		return mv;
	}
	...
	public ModelAndView myMoney() throws Exception{
		...
		pd = ybxKeHuService.getDetailByID(pd);
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/cash_home");
		return mv;
	}
	...
	public ModelAndView fenxiaoMoney() throws Exception{
		...
		mv.setViewName("yibaoxuan/kehuduan/fenxiaoMoenyRecord");
		return mv;
	}
	...
	public ModelAndView gerenziliao() throws Exception{
		...
		pd = ybxKeHuService.getDetailByID(pd);
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/gerenZiliao");
		return mv;
	}
	...
	public ModelAndView xinwenList() throws Exception{
		...
		//公告列表
		List<PageData> gonggaolist=ybxKeHuService.getnewsandnoticeList(pd);
		mv.addObject("gonggaolist", gonggaolist);
		mv.setViewName("yibaoxuan/kehuduan/news/news");
		return mv;
	}
	...
	public ModelAndView gonggaoList() throws Exception{
		...
		List<PageData> gonggaolist=ybxKeHuService.getnewsandnoticeList(pd);
		mv.addObject("gonggaolist", gonggaolist);
		mv.setViewName("yibaoxuan/kehuduan/gonggao/gonggao");
		return mv;
	}
	...
	public Object getkeleiListByParentID() throws Exception{
		...
		pd = this.getPageData();
		//存在session
		List<PageData> keleiList =  ybxKeHuService.getkeleiListByParentID(pd);
		map.put("respCode", "01");
	...
	public ModelAndView gojigou(Page page) throws Exception{
		...
		List<PageData> jigouList = ybxKeHuService.getjigouList(pd);
		List<PageData> listType = ybxKeHuService.getjigouTypeList(page);
		mv.addObject("jigouList", jigouList);
		mv.addObject("listType", listType);
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/region/regin_home_jigou");
		return mv;
	}
	...
	public ModelAndView goYaoshang() throws Exception{
		...
		List<PageData> yaoshangList = ybxKeHuService.getYaoshangList(pd);
		mv.addObject("yaoshangList", yaoshangList);
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/region/regin_home_yaoshang");
		return mv;
	}
	...
	public ModelAndView goDoctor() throws Exception{
		...
		//List<PageData> ParentkeleiList = ybxKeHuService.getkeleiList(pd);
		List<PageData> yishengList = ybxKeHuService.getyishengList(pd);
		//mv.addObject("ParentkeleiList", ParentkeleiList);
		mv.addObject("yishengList", yishengList);
		mv.addObject("pd", pd);
	
		mv.setViewName("yibaoxuan/kehuduan/user/region/regin_home1");
		return mv;
	}
	...
	public Object saveGerenziliao() throws Exception{
		...
		pd.put("user_kuhu_id", zywKeHu.getUser_kuhu_id());
		ybxKeHuService.updateGerenInfo(pd);
		map.put("respCode", "01");
		return AppUtil.returnObject(pd, map);
	...
	public ModelAndView wangjimima(){
		...
		ModelAndView mv=new ModelAndView();
		mv.setViewName("yibaoxuan/kehuduan/registerVIP/searchPass");
		return mv;
	}
	...
	public ModelAndView xinmima(){
		...
		pd =this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/registerVIP/newPass");
		return mv;
	}
	...
	public Object updatePassword(HttpServletRequest request) throws Exception{
		...
		pd.put("phone", phone);
		ybxKeHuService.updatePassword(pd);
		map.put("respCode", "01");
		return AppUtil.returnObject(pd, map);
	}
	...
	public ModelAndView toRegister(){
		...
		ModelAndView mv=new ModelAndView();
		mv.setViewName("yibaoxuan/kehuduan/registerVIP/register");
		return mv;
	}
	...
	public ModelAndView toRegister2(){
		...
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/registerVIP/register2");
		return mv;
	}
	...
	public ModelAndView tuichu(){
		...
		//销毁session
		removeSession();
		mv.setViewName("redirect:/api/ybxkehu/index");
		return mv;
	}
	...
	public ModelAndView gopj()throws Exception {
		...
		pd=this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/pingjia");
		return mv;
	}
	...
	public ModelAndView savePingjia()throws Exception{
		...
		ybxKeHuService.savePingjia(pd);
		
		ybxKeHuService.updateYaoshangFlagState(pd);
		/*if(pd.get("identity").equals("1")){
			ybxKeHuService.updateYishengFlagState(pd);
		}else if(pd.get("identity").equals("3")){
			ybxKeHuService.updateYaoshangFlagState(pd);
		}else{
			ybxKeHuService.updatejigouFlagState(pd);
		}*/
		mv.addObject("pd", pd);
		mv.setViewName("redirect:/api/ybxkehu/huiyuanzhongxin.do");
		return mv;
	}
	...
	public Object register(HttpServletRequest request) throws Exception{
		...
		//根据用户名或者手机号查询对象信息
		PageData tempUserName=ybxKeHuService.getDataByUserName(pdUserName);
		PageData tempPhone=ybxKeHuService.getDataByPhone(pdUserName);
		
		//获取后台设置的注册送积分
		PageData zhuceJifenData = ybxShangHuService.getDataOfJiFenZhuCe(pd);
		//客户主键id
		String respCode = "00";
		String respMsg="";
		...
		/*		//生成二维码
				...
				String logoPath=PathUtil.getClasspath() + "static/yibaoxuan/images/ill.png";
				String filePath="uploadFiles/uploadImgs/kehu/eweima/" + DateUtil.getDays()+"/";
				String imgName = this.get32UUID() + ".png";
				//二维码内容
				String encoderContent = BaseController.getPath(getRequest())+"api/ybxkehu/toRegister2.do?type=1&twoDimensioncode_id="+user_kuhu_id;                       
				//生成带有logo图标二维码图片
	...
	public ModelAndView toLogin(){
		...
		pd =this.getPageData();
		mv.addObject("pd",pd);
		mv.setViewName("yibaoxuan/kehuduan/registerVIP/login");
		return mv;
	}
	...
	public ModelAndView gerenInfo(){
		...
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/zhiliao");
		return mv;
	}
	...
	public ModelAndView registerSH(){
		...
		PageData pd = new PageData();
		pd= this.getPageData();
		mv.setViewName("yibaoxuan/kehuduan/user/registerSH");
		return mv;
	}
	/**
	 * h5分享二维码返回页面并提示
	...
	public ModelAndView fxewm(){
		...
		pd= this.getPageData();
		mv.addObject("tag", pd.get("tag"));
		mv.setViewName("yibaoxuan/kehuduan/user/erweima");
		return mv;
	}
	...
	public ModelAndView myEwm(HttpServletRequest request) throws Exception{
		...
		pd= this.getPageData();
		pd.put("user_kuhu_id", pd.get("user_kuhu_id"));
		PageData pdsData = ybxKeHuService.getErweimaImgById(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView myTeam(){
		...
		pd = this.getPageData();
		mv.addObject("pd", pd);
		mv.setViewName("yibaoxuan/kehuduan/user/myteam");
		return mv;
	}
	...
	public ModelAndView myYijiTeam() throws Exception{
		...
		List<PageData> yijiList = ybxKeHuService.getYijiTeamList(pd);
		rpd = ybxKeHuService.getYijiTeamListCount(pd);
		mv.addObject("rpd", rpd);
		mv.addObject("yijiList", yijiList);
		mv.setViewName("yibaoxuan/kehuduan/user/first_team");
		return mv;
	}
	...
	public ModelAndView getErjiTeamList() throws Exception{
		...
		List<PageData> ErjiList = ybxKeHuService.getErjiTeamList(pd);
		rpd= ybxKeHuService.getErjiTeamListCount(pd);
		mv.addObject("rpd", rpd);
		mv.addObject("ErjiList", ErjiList);
		mv.setViewName("yibaoxuan/kehuduan/user/two_team");
		return mv;
	}
	...
	public ModelAndView myJifen() throws Exception{
		...
		PageData jifenData = ybxKeHuService.getMyjifen(pd);
		//获取积分兑换股权的信息
		...
		mv.setViewName("yibaoxuan/kehuduan/user/mineJifen");
		return mv;
	}
	/**
	 * 积分换股权操作
	...
	public Object jiFenHuanGuQuan() throws Exception{
		...
		if(isSession()){
			//获取我的积分
			pd.put("user_kehu_id", getSessionUser().getUser_kuhu_id());
			pd=ybxKeHuService.getjgDataById(pd);
			pd.put("user_kehu_id", getSessionUser().getUser_kuhu_id());
			//获取积分兑换股权的信息
			PageData tempPd=ybxShangHuService.getDataOfJiFenHuanGuQuan(pd);
			...
			ybxKeHuService.updateJiFenAndGuQuan(pd);
	...
	public ModelAndView myGuquan() throws Exception{
		...
		PageData ppData = ybxKeHuService.getGuquanAndXunibi(pd);
		mv.addObject("ppData", ppData);
		mv.setViewName("yibaoxuan/kehuduan/user/myGuquan");
		return mv;
	}
	/**
	 * 找医网客户端  我的虚拟币
	...
	public ModelAndView myXunibi() throws Exception{
		...
		PageData ppData = ybxKeHuService.getGuquanAndXunibi(pd);
		mv.addObject("ppData", ppData);
		mv.setViewName("yibaoxuan/kehuduan/user/myXunibi");
		return mv;
	}
	...
	public ModelAndView myOrder() throws Exception{
		...
		PageData jifenData = ybxKeHuService.getMyjifen(pd);
		mv.addObject("jifenData", jifenData);
		mv.setViewName("yibaoxuan/kehuduan/user/myjifen");
		return mv;
	}
	...
	public Object login(HttpSession session) throws Exception{
		...
		PageData tempData=ybxKeHuService.getDataByUserNameAndPassword(tempPd);
		PageData ispd= ybxKeHuService.isExistUser(tempPd);
		if(ispd==null){
			 respCode = "02";
			 respMsg="该用户未注册";
			...
			ybxKeHuService.updateLastLoginTime(pd);
	...
	public String registerShanghu(HttpServletRequest request,PageData pd) throws Exception{
		...
		if(tempUserName!=null){//该用户名已经存在
			...
			if(tempPhone!=null){//该手机号已经注册
				...
				pd.put("bz", "app用户");
				//获取注册送积分
				PageData tempData=ybxShangHuService.getDataOfJiFenZhuCe(pd);
	...
	public Object ew_register(HttpServletRequest request) throws Exception{
		...
		//查出积分
		//获取到后台设置的积分 返回pd
		PageData jifenPd = ybxKeHuService.getjifen(pd);
		PageData pds = new PageData();
		...
		//根据条件是二级id查到结果
		PageData pdall2 = ybxKeHuService.chaErji(pds);
		if(pdall2!=null){
			...
			ybxKeHuService.updateJifenByEwmRegister(pp);
			//一级推荐人得少数 --50分
			pp.put("jifen", jf2+"");
			...
			if(pdall1!=null){
				...
				if(pd0_rs.get("erji_id").equals("")){
					...
					if(type.equals("2")){
						...
						//获取医生的积分
						PageData ding_jifenData = ybxShangHuService.getShangHuJifen(pjf);
						//一级推荐人的原积分
						String yi_yjifen = yi_jifenData.getString("jifen");
						//顶级推荐人的原积分
						...
						ybxShangHuService.updateJifenToShanghu(pp);
					}else{
						...
						PageData ding_jifenData = ybxKeHuService.getMyjifen(pjf);
						/**
						 * 	///////////////////////////****注意******!!!!!/////////////////////////////////////////
						 */
						///////////////////如果顶级是医生 ding_jifenData必然等于null/////////////////////////
						if(ding_jifenData==null||ding_jifenData.getString("jifen").equals("")){
							 ding_jifenData = ybxShangHuService.getShangHuJifen(pjf);
						}
						//一级推荐人的原积分
						String yi_yjifen = yi_jifenData.getString("jifen");
						//顶级推荐人的原积分
				...
				//2是医生
				if(type.equals("2")){
					PageData pdall12 = ybxKeHuService.chaDingji(pds);
					System.out.println("=====================医生它是顶级哦=====================");
					//是顶级，则要更新一级字段，先判断该顶级下有没有一级用户
					PageData p0 = new PageData();
					p0.put("dingji_id", pdall12.get("dingji_id"));
					PageData pd_dingji = ybxKeHuService.selectYijiByDingji(p0);
					...
					if(!pd_dingji.get("yiji_id").equals("")){
						...
						p02.put("erji_id", "");
						p02.put("type","1");
						ybxKeHuService.insertYiji(p02);
						
						//修改医生的积分
						PageData pjf = new PageData();
						pjf.put("user_shanghu_id", pdall12.get("dingji_id"));
						PageData jifenData = ybxShangHuService.getShangHuJifen(pjf);
						//原积分
						...
						//修改医生的积分
						ybxShangHuService.updateJifenToShanghu(pjf);
				...
				//客户
					...
					if(!pd_dingji.get("yiji_id").equals("")){
						...
						PageData jifenData = ybxKeHuService.getMyjifen(pjf);
						//原积分
						String yjifen = jifenData.getString("jifen");
						//预设置积分
						String sjifen =jifenPd.getString("fx1_num");
						...
						pjf.put("jifen", jf+"");
						pjf.put("tjr_user_id", pdall12.get("dingji_id"));
						ybxKeHuService.updateJifenByEwmRegister(pjf);
	...
	public ModelAndView getYnzzlistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list =ybxKeHuService.getYnzzlistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
	...
	public Object getNameByID() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		PageData tempPd=ybxKeHuService.getNameByID(pd);
		String reqCode="00";
		String reqMsg="该疾病名称已存在";
		if(tempPd==null){
			reqCode="01";
...
/*	@RequestMapping(value="/getJiBingListByLetter")
	...
	public ModelAndView toEditYnzz() throws Exception {
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		pd = ybxKeHuService.getNameByID(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView updateYnzz()throws Exception {
		...
		ybxKeHuService.updateYnzzByID(pd);
		mv.addObject("msg", "success");
		mv.setViewName("save_result");
		return mv;
	}
	...
	public void deleteYnzzById(PrintWriter writer) throws Exception {
		...
		map.put("ids", ids);
		ybxKeHuService.deleteYnzzById(map);
		writer.close();
	}
	...
	public Object getYnzzByName() throws Exception{
		...
		PageData pd=new PageData();
		pd=this.getPageData();
		PageData tempPd=ybxKeHuService.getYnzzByName(pd);
		String reqCode="00";
	...
	public ModelAndView getYnzzList(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list =ybxKeHuService.getYnzzList(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("yibaoxuan/kehuduan/disease/ynzzList");
		return mv;
	}
	...
	public ModelAndView getjigoulistPage(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		List<PageData> list = ybxKeHuService.getjigouTypeList(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
	...
	public ModelAndView yijiuzhen(Page page) throws Exception {
		...
		pd = this.getPageData();
		page.setPd(pd);
		PageData rpd = ybxKeHuService.getAmountById(pd);
		if(rpd!=null){
			//成交金额
			...
			//修改商户的金额
			ybxKeHuService.updateAmountById(pdset);
		}
		pd.put("complete_time", DateUtil.getTime());
		/*if(pd.get("type").equals("1")){
			//修改医生订单状态
			ybxKeHuService.updateYishengOrderState(pd);
		}else if(pd.get("type").equals("3")){
			//修改药商订单状态
			ybxKeHuService.updateYaoshangOrderState(pd);
		}else{
			//修改机构订单状态
			ybxKeHuService.updatejigouOrderState(pd);
		}*/
		ybxKeHuService.updateYaoshangOrderState(pd);
		//==================================购买服务分销提成begin============================================//
		...
		//根据二级id查出顶级和一级
		PageData erjiResult= ybxKeHuService.selectIsErji(pds);
		//查出分销提成的比例
		PageData tichenBili= ybxKeHuService.selectFenXiaoTichen(pds);
		//获取平台技术服务扣除比例对象
		...
		if(erjiResult!=null){
			...
			PageData yijimoney = ybxKeHuService.getMoneyBykehuID(pds);
			...
			ybxKeHuService.updateMoneyBykehuID(upd);
			...
			ybxKeHuService.insertTichenMoneyRecord(pdTc);
			...
			PageData dingjimoney = ybxKeHuService.getMoneyBykehuID(pdding);
			//表示顶级分销人是客户
			if(dingjimoney!=null){
				...
				ybxKeHuService.updateMoneyBykehuID(upd2);
				//保存客户或者商户的分销提成金额记录
				...
				ybxKeHuService.insertTichenMoneyRecord(pdTc2);
			}else{
				//表示这个顶级分销人是商户
				PageData dingji = new PageData();
				//传入顶级人的id,查出顶级人的金额
				dingji.put("user_shanghu_id", erjiResult.get("dingji_id"));
				PageData shangHuMoney = ybxKeHuService.getMoneyByShangHuID(dingji);
				...
				ybxKeHuService.updateMoneyBykehuID(upd_shanghu);
			...
			//查一级数据
			PageData yijiData = ybxKeHuService.selectIsYiji(pds);
			if(yijiData!=null){
	...
	public Object getKehuHeadImgAnduserName(HttpServletRequest request) throws Exception{
		...
		if(Tools.isEmpty(pd.getString("user_kehu_id"))){
			...
			PageData rpd = ybxKeHuService.getKehuHeadImgAnduserName(pd);
			if(rpd!=null){
				map.put("respCode", "01");
				map.put("user_kuhu_id", rpd.get("user_kuhu_id"));
				map.put("headImg_url", BaseController.getPath(request) + "static/yibaoxuan/images/ill.png");
	...
	public Object getShanghuHeadImgAnduserName(HttpServletRequest request) throws Exception{
		...
		if(Tools.isEmpty(pd.getString("user_shanghu_id"))){
			...
			PageData rpd = ybxKeHuService.getShanghuHeadImgAnduserName(pd);
			if(rpd!=null){
				map.put("respCode", "01");
