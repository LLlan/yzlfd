...
@Controller
@RequestMapping(value="/api/ljylorder")
public class LjylOrderController extends BaseController{
	...
	public ModelAndView toRegin_pay() throws Exception{
		...
		pd=this.getPageData();
		//根据服务的主键ID获取对象信息
		tempPd=ljylShangHuService.getDataByIdOfService(pd);
		...
		mv.addObject("pd", pd);	
		mv.setViewName("lvjuyanglao/kehuduan/user/region/regin_pay");
		return mv;
	}
	...
	public ModelAndView getOrderOfYiShenglistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getOrderOfYiShenglistPage(page);
		mv.addObject("pd", pd);
	...
	public ModelAndView getOrderOfJiGoulistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getOrderOfJiGoulistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
	...
	public ModelAndView getOrderOfYaoShanglistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getOrderOfYaoShanglistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
		mv.setViewName("lvjuyanglao/shanghuorder/yaoshangorder_list");
		return mv;
	}
	/**
	 * 后台获取客户订单列表
	...
	public ModelAndView getOrderOfKeHulistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getOrderOfKeHulistPage(page);
		mv.addObject("pd", pd);
		mv.addObject("list", list);
	...
	public ModelAndView getShouYiOfYiShenglistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getShouYiOfYiShenglistPage(page);
		PageData sum=ljylOrderService.getShouYiOfYiShengSum(pd);
		mv.addObject("pd", pd);
	...
	public ModelAndView getShouYiOfJiGoulistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getShouYiOfJiGoulistPage(page);
		PageData sum=ljylOrderService.getShouYiOfJiGouSum(pd);
		mv.addObject("pd", pd);
		mv.addObject("sum", sum.get("sum"));
		mv.addObject("list", list);
	...
	public ModelAndView getShouYiOfYaoShanglistPage(Page page) throws Exception{
		...
		pd=this.getPageData();
		page.setPd(pd);
		List<PageData> list=ljylOrderService.getShouYiOfYaoShanglistPage(page);
		PageData sum=ljylOrderService.getShouYiOfYaoShangSum(pd);
		mv.addObject("pd", pd);
		mv.addObject("sum", sum.get("sum"));
		mv.addObject("list", list);
		mv.setViewName("lvjuyanglao/pingtaishouyi/yaoshangshouyi_list");
		return mv;
	}
