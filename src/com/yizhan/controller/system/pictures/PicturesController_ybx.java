...
import com.yizhan.service.system.pictures.PicturesService_ybx;
...
@Controller
@RequestMapping(value="/pictures_ybx")
public class PicturesController_ybx extends BaseController {
	public static final String IMGPATH = "banner/";	//图片上传路径
	@Resource(name="picturesService_ybx")
	private PicturesService_ybx picturesService;
