package com.yizhan.controller.system.role;
...
public class RoleController extends BaseController {
	...
	public ModelAndView roleList(Page page) throws Exception{
		...
		List<Role> yijiRoles =  roleService.listRoles();
		mv.addObject("yijiRoles", yijiRoles);
		mv.setViewName("system/role/role_manager_list");
		return mv;
	}
	 ...
	 * @param response
	 */
	@RequestMapping(value="/getRoleByParentId")
	public void getRoleByParentId(@RequestParam String roleId,HttpServletResponse response)throws Exception{
		try {
			List<Role> roles = roleService.listRoleByParentId(roleId);
