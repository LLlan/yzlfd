...
//    }
    ...
    public static String getYearAddMonth(int addMonth, String date) {
        String resultDate;
        SimpleDateFormat from_sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        Calendar cal = Calendar.getInstance();
            try {
                java.util.Date tempDate = from_sdf.parse(date);
                cal.setTime(tempDate);
            } catch (ParseException e) {
            }
	...
	public void main(String[] args) throws Exception {
		String str1 = "2017-06-25";
		String str2 = "2017-07-01";
