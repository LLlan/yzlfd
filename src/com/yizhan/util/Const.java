  ...
  public class Const
  {
    ...
    public static final String SESSION_KEHU_USER = "kehuUser";
    public static final String SESSION_SHANGHU_USER = "shanghuUser";
    ...
    public static final String SYSNAME_LJYL = "admin/config/SYSNAME_LJYL.txt";
    public static final String SYSNAME_YBX = "admin/config/SYSNAME_YBX.txt";
